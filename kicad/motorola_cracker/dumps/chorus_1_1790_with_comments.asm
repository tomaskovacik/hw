...
; 
          db $0E, $13, $6A, $07         ; data?  ,  , j,                          
          db $13, $4F, $B6, $1F         ; data?  , O,  ,                          
          db $AB, $88, $97, $B6         ; data?  ,  ,  ,                          
          db $1E, $A9                   ; data?  ,  ,  ,                          
; 
L0444: 
          ...
          brset 3,PortD,L0453           ; Branch to 0x0453 if LSR_TEST_PHANTOM is HIGH
; 
          db $02, $02                   ; data?  ,  ,  ,                          
; 
L0453: 
...
; 
          db $13, $67, $10, $67         ; data?  , g,  , g                        
          db $0F, $5D, $56, $1F         ; data?  , ], V,                          
          db $5D, $B6                   ; data? ],  ,  ,                          
; 
L06C5: 
...
; 
          db $CC, $45, $44, $CC         ; data?  , E, D,                          
L06F8: 
          db $35, $A9, $CC, $38         ; data? 5,  ,  , 8                        
; 
L06FC: 
...
; 
          db $CC, $43, $DE, $CC         ; data?  , C,  ,                          
          db $4A, $AB, $CC, $2B         ; data? J,  ,  , +                        
L0711: 
          db $41                        ; data? A,  ,  ,                          
; 
L0712: 
...
L0743: 
          ...
          brset 1,PortC,L074B           ; Branch to 0x074B if WDOG_TEL is HIGH    
          bset 4,RAM1_05d               ; Set Bit 4 at memory RAM1_05d (Mn <- 1 ) 
L074B: 
          bclr 1,PortC                  ; Set WDOG_TEL LOW                        
L074D: 
...
L0789: 
          ...
          brclr 1,PortD,L07BB           ; Branch to 0x07BB if DIAG is LOW         
L0792: 
          rts                           ; Return from Subroutine                  
; 
L0793: 
...
L07BD: 
          brclr 1,DDRC,L07C4            ; Branch to 0x07C4 if WDOG_TEL is set to INPUT
...
L07C4: 
          ...
          brclr 1,PortC,L07CD           ; Branch to 0x07CD if WDOG_TEL is LOW     
...
L07D7: 
          clra                          ; Clear byte at clra <- 0x00              
          brset 2,PortD,L07DD           ; Branch to 0x07DD if PANEL_ON_OFF is HIGH
          ora #$01                      ; Logical OR Accumulator with Memory at 0x01, A <- (A) || (0x01)
L07DD: 
          brset 0,PortD,L07E2           ; Branch to 0x07E2 if S-KONT is HIGH      
...
L07E7: 
          brclr 1,PortD,L07EC           ; Branch to 0x07EC if DIAG is LOW         
...
L07F2: 
          brclr 6,PortD,L07F7           ; Branch to 0x07F7 if NAVI_IN is LOW      
L07F5: 
...
; 
          ...
          db $0A, $03, $5B, $1A         ; data?  ,  , [,                          
          db $01, $61, $75, $12         ; data?  , a, u,                          
          db $61, $20, $6A, $00         ; data? a, SPACE, j,                      
          db $61, $08, $03, $5B         ; data? a,  ,  , [                        
          db $0D, $00, $5F, $56         ; data?  ,  , _, V                        
          db $1A, $5F, $13, $61         ; data?  , _,  , a                        
          db $03, $5B, $03, $06         ; data?  , [,  ,                          
          db $CE, $4C, $09, $5B         ; data?  , L,  , [                        
          db $13, $00, $61, $03         ; data?  ,  , a,                          
          db $03, $5F, $0D, $07         ; data?  , _,  ,                          
          db $60, $0A, $17, $60         ; data? `,  ,  , `                        
          db $08, $5F, $02, $10         ; data?  , _,  ,                          
          db $60, $02, $0C, $03         ; data? `,  ,  ,                          
          db $05, $5B, $03, $01         ; data?  , [,  ,                          
          db $61, $42, $81, $CD         ; data? a, B,  ,                          
          db $1F, $FF, $CD, $1F         ; data?  ,  ,  ,                          
          db $F6, $CD, $47, $7E         ; data?  ,  , G, ~                        
          db $A6, $C8, $B7, $63         ; data?  ,  ,  , c                        
          db $3D, $63, $27, $30         ; data? =, c, ', 0                        
          db $07, $67, $05, $17         ; data?  , g,  ,                          
          db $67, $CD, $47, $AA         ; data? g,  , G,                          
          db $CD, $47, $F4, $CD         ; data?  , G,  ,                          
          db $3F, $BE, $0F, $92         ; data?  ,  ,  ,                          
          db $EB, $08, $92, $E8         ; data?  ,  ,  ,                          
          db $10, $61, $1E, $60         ; data?  , a,  , `                        
          db $1C, $60, $20, $14         ; data?  , `, SPACE,                      
          db $19, $61, $10, $61         ; data?  , a,  , a                        
          db $3F, $93, $03, $5F         ; data?  ,  ,  , _                        
          db $0B, $13, $61, $20         ; data?  ,  , a, SPACE                    
          db $07                        ; data?  ,  ,  ,                          
; 
L08A3: 
...
; 
          db $05, $9E, $03, $CD         ; data?  ,  ,  ,                          
          db $38, $9F, $0C, $5F         ; data? 8,  ,  , _                        
          db $03, $CD, $30, $69         ; data?  ,  , 0, i                        
          db $0A, $5F, $03, $CD         ; data?  , _,  ,                          
          db $20, $1B, $CD, $07         ; data? SPACE,  ,  ,                      
          db $89, $0C, $5F, $07         ; data?  ,  , _,                          
          db $11, $01, $AE, $02         ; data?  ,  ,  ,                          
          db $CD, $25, $57, $0A         ; data?  , %, W,                          
          ...
          db $02, $CD, $25, $57         ; data?  ,  , %, W                        
          db $1B, $61, $CD, $30         ; data?  , a,  , 0                        
          db $69, $CD, $13, $7A         ; data? i,  ,  , z                        
          db $0B, $5F, $2D, $13         ; data?  , _, -,                          
          db $81, $14, $12, $18         ; data?  ,  ,  ,                          
          db $12, $CD, $1F, $F6         ; data?  ,  ,  ,                          
          db $CD, $47, $7E, $CD         ; data?  , G, ~,                          
          db $0B, $1D, $18, $61         ; data?  ,  ,  , a                        
          db $10, $80, $A6, $80         ; data?  ,  ,  ,                          
          db $B7, $7D, $B7, $7B         ; data?  , },  , {                        
          db $07, $8E, $02, $AA         ; data?  ,  ,  ,                          
          db $10, $B7, $D5, $1C         ; data?  ,  ,  ,                          
          db $94, $1A, $94, $12         ; data?  ,  ,  ,                          
          db $94, $19, $6B, $1C         ; data?  ,  , k,                          
          db $95, $CC, $09, $B7         ; data?  ,  ,  ,                          
          db $15, $12, $0A, $61         ; data?  ,  ,  , a                        
          db $F8, $CD, $30, $69         ; data?  ,  , 0, i                        
          db $07, $60, $29, $04         ; data?  , `, ),                          
          db $5F, $03, $CC, $0A         ; data? _,  ,  ,                          
          db $5B, $CD, $20, $31         ; data? [,  , SPACE, 1                    
          db $A6, $FA, $B7, $12         ; data?  ,  ,  ,                          
          db $A6, $64, $B7, $63         ; data?  , d,  , c                        
          db $CD, $07, $89, $CD         ; data?  ,  ,  ,                          
          db $3F, $BE, $08, $60         ; data?  ,  ,  , `                        
          db $32, $0A, $5F, $2F         ; data? 2,  , _, /                        
          db $CD, $22, $23, $0D         ; data?  , ",  #,                         
          db $5F, $EE, $3D, $63         ; data? _,  , =, c                        
          db $26, $EA, $20, $23         ; data? &,  , SPACE,  #                   
          db $CD, $1F, $E2, $A6         ; data?  ,  ,  ,                          
          db $5A, $B7, $12, $A6         ; data? Z,  ,  ,                          
          db $FA, $B7, $63, $CD         ; data?  ,  , c,                          
          db $07, $89, $CD, $3F         ; data?  ,  ,  ,                          
          db $BE, $08, $60, $0F         ; data?  ,  , `,                          
          db $0A, $5F, $0C, $06         ; data?  , _,  ,                          
          db $60, $09, $09, $5F         ; data? `,  ,  , _                        
          db $EA, $3D, $63, $26         ; data?  , =, c, &                        
          db $EA, $16, $60, $CC         ; data?  ,  , `,                          
          db $05, $06, $A6, $64         ; data?  ,  ,  , d                        
          db $B7, $63, $A6, $1E         ; data?  , c,  ,                          
          db $B7, $68, $1D, $67         ; data?  , h,  , g                        
          db $13, $01, $A6, $5B         ; data?  ,  ,  , [                        
          db $B7, $A6, $9A, $0D         ; data?  ,  ,  ,                          
          db $5F, $0E, $CD, $13         ; data? _,  ,  ,                          
          db $E0, $CD, $36, $F2         ; data?  ,  , 6,                          
          db $CD, $33, $FF, $CD         ; data?  , 3,  ,                          
          db $30, $6C, $10, $01         ; data? 0, l,  ,                          
          db $CD, $07, $89, $CD         ; data?  ,  ,  ,                          
          db $3F, $BE, $08, $60         ; data?  ,  ,  , `                        
          db $D2, $2E, $70, $CD         ; data?  , ., p,                          
          db $4B, $17, $CD, $22         ; data? K,  ,  , "                        
          db $23, $05, $12, $03         ; data?  #,  ,  ,                         
          db $CD, $47, $F4, $07         ; data?  , G,  ,                          
          db $67, $D4, $17, $67         ; data? g,  ,  , g                        
          db $0D, $5F, $11, $CD         ; data?  , _,  ,                          
          db $13, $BC, $CD, $36         ; data?  ,  ,  , 6                        
          db $AE, $CD, $30, $72         ; data?  ,  , 0, r                        
          db $0B, $67, $05, $1B         ; data?  , g,  ,                          
          db $67, $CD, $13, $CE         ; data? g,  ,  ,                          
          db $05, $12, $32, $0B         ; data?  ,  , 2,                          
          db $5F, $A5, $CD, $2C         ; data? _,  ,  , ,                        
          db $60, $CD, $0B, $AC         ; data? `,  ,  ,                          
          db $CD, $47, $AA, $09         ; data?  , G,  ,                          
          db $67, $AC, $19, $67         ; data? g,  ,  , g                        
          db $3A, $A7, $27, $15         ; data? :,  , ',                          
          db $0E, $5F, $9F, $B6         ; data?  , _,  ,                          
          db $9A, $A1, $F0, $25         ; data?  ,  ,  , %                        
          db $99, $07, $5F, $9A         ; data?  ,  , _,                          
          db $02, $5F, $97, $A6         ; data?  , _,  ,                          
          db $02, $B7, $A6, $20         ; data?  ,  ,  , SPACE                    
          db $91, $3A, $A6, $26         ; data?  , :,  , &                        
          db $8D, $1B, $5F, $20         ; data?  ,  , _, SPACE                    
          db $89, $0A, $5F, $68         ; data?  ,  , _, h                        
          db $01, $A1, $03, $CC         ; data?  ,  ,  ,                          
          db $09, $B7, $0D, $67         ; data?  ,  ,  , g                        
          db $07, $06, $B9, $5C         ; data?  ,  ,  , \                        
          ...
          db $04, $E5, $9B, $19         ; data?  ,  ,  ,                          
          db $0C, $CD, $1F, $E2         ; data?  ,  ,  ,                          
          db $A6, $5A, $B7, $12         ; data?  , Z,  ,                          
          db $12, $0C, $A6, $14         ; data?  ,  ,  ,                          
          db $B7, $63, $3F, $0B         ; data?  , c,  ,                          
          db $3F, $76, $3F, $5E         ; data?  , v,  , ^                        
          db $3F, $A8, $3F, $A6         ; data?  ,  ,  ,                          
          db $3F, $09, $3F, $0F         ; data?  ,  ,  ,                          
          db $9A, $CD, $07, $89         ; data?  ,  ,  ,                          
          db $A6, $08, $BB, $1A         ; data?  ,  ,  ,                          
          ...
          db $A6, $27, $B7, $09         ; data?  , ',  ,                          
          db $CD, $21, $A2, $0A         ; data?  , !,  ,                          
          db $5F, $16, $3D, $63         ; data? _,  , =, c                        
          db $26, $1C, $06, $00         ; data? &,  ,  ,                          
          db $0C, $17, $00, $16         ; data?  ,  ,  ,                          
          db $04, $4F, $4A, $26         ; data?  , O, J, &                        
          db $FD, $17, $04, $3F         ; data?  ,  ,  ,                          
          db $6A, $0D, $5F, $03         ; data? j,  , _,                          
          db $CC, $05, $06, $11         ; data?  ,  ,  ,                          
          db $05, $0F, $64, $02         ; data?  ,  , d,                          
          db $1D, $61, $0C, $5F         ; data?  , a,  , _                        
          db $BF, $2E, $9C, $05         ; data?  , .,  ,                          
          db $12, $0C, $3D, $63         ; data?  ,  , =, c                        
          db $26, $B6, $1A, $01         ; data? &,  ,  ,                          
          db $17, $00, $16, $04         ; data?  ,  ,  ,                          
          db $20, $9A, $0F, $09         ; data? SPACE,  ,  ,                      
          db $FD, $3D, $A8, $26         ; data?  , =,  , &                        
          db $0B, $07, $A6, $22         ; data?  ,  ,  , "                        
          db $B6, $A4, $BE, $A5         ; data?  ,  ,  ,                          
          db $AD, $3F, $20, $30         ; data?  ,  , SPACE, 0                    
          db $B6, $A8, $B0, $08         ; data?  ,  ,  ,                          
          db $25, $14, $A1, $03         ; data? %,  ,  ,                          
          db $25, $10, $14, $12         ; data? %,  ,  ,                          
          db $18, $12, $17, $01         ; data?  ,  ,  ,                          
          db $16, $05, $A6, $30         ; data?  ,  ,  , 0                        
          db $B7, $63, $1B, $01         ; data?  , c,  ,                          
          db $20, $1A, $B6, $08         ; data? SPACE,  ,  ,                      
          db $BB, $A5, $B7, $A5         ; data?  ,  ,  ,                          
          db $24, $02, $3C, $A4         ; data? $,  , <,                          
          db $3C, $A6, $B6, $A6         ; data? <,  ,  ,                          
          db $A5, $3F, $26, $0E         ; data?  ,  , &,                          
...
; 
L0B7A: 
          brclr 3,PortB,L0384           ; Branch to 0x0384 if MUTE_WOOFER is LOW  
          bclr 3,PortB                  ; Set MUTE_WOOFER LOW                     
...
; 
          ...
          db $03, $CC, $0C, $DA         ; data?  ,  ,  ,                          
          db $CC, $0C, $C6, $4A         ; data?  ,  ,  , J                        
          db $26, $13, $AE, $AD         ; data? &,  ,  ,                          
          db $CD, $37, $C7, $27         ; data?  , 7,  , '                        
          db $03, $02, $7C, $0C         ; data?  ,  , |,                          
          db $0E, $7C, $ED, $02         ; data?  , |,  ,                          
          db $7C, $EA, $CC, $0C         ; data? |,  ,  ,                          
          db $DA, $4A, $26, $06         ; data?  , J, &,                          
          db $00, $BA, $77, $CC         ; data?  ,  , w,                          
          db $0C, $DA, $0C, $80         ; data?  ,  ,  ,                          
          db $71, $CC, $0C, $DA         ; data? q,  ,  ,                          
          db $A6, $80, $B7, $87         ; data?  ,  ,  ,                          
          ...
          db $87, $07, $CD, $0F         ; data?  ,  ,  ,                          
          db $67, $A6, $14, $20         ; data? g,  ,  , SPACE                    
          db $09, $A6, $FE, $B7         ; data?  ,  ,  ,                          
          db $88, $CD, $0F, $4C         ; data?  ,  ,  , L                        
          db $A6, $50, $B7, $8A         ; data?  , P,  ,                          
          db $CC, $0D, $77, $3A         ; data?  ,  , w, :                        
          db $8A, $26, $1A, $01         ; data?  , &,  ,                          
          db $81, $53, $A6, $02         ; data?  , S,  ,                          
          db $B7, $8A, $CD, $12         ; data?  ,  ,  ,                          
          db $2E, $27, $2D, $0F         ; data? ., ', -,                          
          db $82, $19, $B8, $82         ; data?  ,  ,  ,                          
          db $B7, $82, $16, $7E         ; data?  ,  ,  , ~                        
          ...
          db $0E, $82, $D1, $0E         ; data?  ,  ,  ,                          
          db $82, $04, $CD, $0F         ; data?  ,  ,  ,                          
          db $4C, $81, $CD, $12         ; data? L,  ,  ,                          
          db $2E, $26, $17, $1B         ; data? ., &,  ,                          
          db $82, $0F, $82, $C0         ; data?  ,  ,  ,                          
          db $1D, $82, $19, $80         ; data?  ,  ,  ,                          
          db $0F, $82, $DA, $3F         ; data?  ,  ,  ,                          
          db $8A, $00, $80, $D5         ; data?  ,  ,  ,                          
          db $CD, $0F, $67, $CC         ; data?  ,  , g,                          
          db $0B, $EB, $0F, $82         ; data?  ,  ,  ,                          
          db $CD, $A6, $02              ; data?  ,  ,  ,                          
; 
L0CFB: 
...
; 
          db $03, $81, $48, $04         ; data?  ,  , H,                          
          db $82, $5F, $07, $82         ; data?  , _,  ,                          
          db $0E, $03, $01, $06         ; data?  ,  ,  ,                          
          db $13, $01, $AE, $04         ; data?  ,  ,  ,                          
          db $20, $4F, $0F, $6B         ; data? SPACE, O,  , k                    
          db $50, $20, $46, $04         ; data? P, SPACE, F,                      
          db $BE, $AA, $07, $01         ; data?  ,  ,  ,                          
          db $0C, $17, $01, $AE         ; data?  ,  ,  ,                          
          db $01, $0F, $6B, $4A         ; data?  ,  , k, J                        
          db $03, $01, $47, $20         ; data?  ,  , G, SPACE                    
          db $41, $AE, $02, $01         ; data? A,  ,  ,                          
          db $61, $3E, $0E, $6B         ; data? a, >,  , k                        
          db $06, $1E, $6B, $1C         ; data?  ,  , k,                          
          db $95, $20, $37, $02         ; data?  , SPACE, 7,                      
          db $01, $06, $12, $01         ; data?  ,  ,  ,                          
          db $AE, $01, $20, $2E         ; data?  ,  , SPACE, .                    
          db $AE, $03, $03, $90         ; data?  ,  ,  ,                          
          db $27, $16, $01, $AE         ; data? ',  ,  ,                          
          db $06, $20, $23, $00         ; data?  , SPACE,  #,                     
          db $61, $0A, $0E, $5F         ; data? a,  ,  , _                        
          db $14, $06, $5F, $11         ; data?  ,  , _,                          
          db $17, $01, $20, $12         ; data?  ,  , SPACE,                      
          db $02, $01, $0A, $12         ; data?  ,  ,  ,                          
          db $01, $1F, $6B, $1C         ; data?  ,  , k,                          
          db $95, $AE, $04, $20         ; data?  ,  ,  , SPACE                    
          db $09, $01, $02, $02         ; data?  ,  ,  ,                          
          db $16, $01, $AE, $05         ; data?  ,  ,  ,                          
          db $10, $81, $D6, $13         ; data?  ,  ,  ,                          
          db $20, $B7, $8A, $18         ; data? SPACE,  ,  ,                      
          db $12, $81, $BE, $85         ; data?  ,  ,  ,                          
          db $D6, $12, $D0, $03         ; data?  ,  ,  ,                          
          db $81, $03, $D6, $12         ; data?  ,  ,  ,                          
          db $F0, $B7, $58, $08         ; data?  ,  , X,                          
          db $80, $0F, $0C, $82         ; data?  ,  ,  ,                          
          db $09, $0E, $87, $09         ; data?  ,  ,  ,                          
          db $0E, $82, $03, $0B         ; data?  ,  ,  ,                          
          db $82, $03, $CC, $0E         ; data?  ,  ,  ,                          
          db $6D, $CD, $12, $4C         ; data? m,  ,  , L                        
          db $0E, $87, $1D, $08         ; data?  ,  ,  ,                          
          db $7F, $41, $AE, $A9         ; data? DEL, A,  ,                        
          db $CD, $12, $5B, $0B         ; data?  ,  , [,                          
          db $7F, $03, $02, $A1         ; data? DEL,  ,  ,                        
          db $09, $0D, $7F, $33         ; data?  ,  , DEL, 3                      
          db $3D, $58, $27, $12         ; data? =, X, ',                          
          db $3A, $58, $BF, $86         ; data? :, X,  ,                          
          db $B6, $57, $20, $0A         ; data?  , W, SPACE,                      
          db $0D, $87, $07, $CB         ; data?  ,  ,  ,                          
          db $13, $27, $24, $02         ; data?  , ', $,                          
          db $A6, $FF, $B1, $58         ; data?  ,  ,  , X                        
          db $22, $02, $B7, $58         ; data? ",  ,  , X                        
          db $0F, $87, $14, $0C         ; data?  ,  ,  ,                          
          db $87, $11, $B6, $87         ; data?  ,  ,  ,                          
          db $44, $A4, $0F, $97         ; data? D,  ,  ,                          
          db $B6, $58, $DB, $13         ; data?  , X,  ,                          
          db $10, $24, $02, $A6         ; data?  , $,  ,                          
          db $FF, $B7, $58, $0C         ; data?  ,  , X,                          
          db $81, $0C, $B6, $84         ; data?  ,  ,  ,                          
          db $27, $08, $48, $40         ; data? ',  , H, @                        
          db $BB, $58, $25, $04         ; data?  , X, %,                          
          db $4F, $C1, $B6, $58         ; data? O,  ,  , X                        
          db $07, $81, $04, $A6         ; data?  ,  ,  ,                          
          db $80, $B0, $85, $B7         ; data?  ,  ,  ,                          
          db $58, $04, $BE, $32         ; data? X,  ,  , 2                        
          db $06, $82, $6D, $04         ; data?  ,  , m,                          
          db $82, $19, $04, $6B         ; data?  ,  ,  , k                        
          db $03, $03, $6B, $06         ; data?  ,  , k,                          
          db $15, $6B, $13, $6B         ; data?  , k,  , k                        
          db $1C, $95, $03, $81         ; data?  ,  ,  ,                          
          db $1D, $02, $01, $1A         ; data?  ,  ,  ,                          
          db $08, $82, $17, $16         ; data?  ,  ,  ,                          
          db $82, $20, $51, $AE         ; data?  , SPACE, Q,                      
          db $AE, $CD, $37, $C7         ; data?  ,  , 7,                          
          db $A4, $07, $4A, $48         ; data?  ,  , J, H                        
          db $48, $CB, $13, $28         ; data? H,  ,  , (                        
          ...
          db $83, $CD, $0F, $73         ; data?  ,  ,  , s                        
          db $38, $59, $B6, $58         ; data? 8, Y,  , X                        
          db $B0, $59, $24, $01         ; data?  , Y, $,                          
          db $4F, $48, $24, $02         ; data? O, H, $,                          
          db $A6, $FF, $B7, $58         ; data?  ,  ,  , X                        
          db $B7, $59, $0C, $82         ; data?  , Y,  ,                          
          db $0F, $0E, $87, $0C         ; data?  ,  ,  ,                          
          db $B6, $88, $B0, $58         ; data?  ,  ,  , X                        
          db $27, $5E, $46, $A8         ; data? ', ^, F,                          
          db $7F, $09, $81, $04         ; data? DEL,  ,  ,                        
          db $B6, $58, $20, $41         ; data?  , X, SPACE, A                    
          db $AE, $20, $CD, $12         ; data?  , SPACE,  ,                      
          db $79, $48, $0A, $82         ; data? y, H,  ,                          
          db $02, $AB, $10, $AB         ; data?  ,  ,  ,                          
          db $00, $97, $D6, $12         ; data?  ,  ,  ,                          
          db $B0, $3A, $8A, $2B         ; data?  , :,  , +                        
          ...
          db $48, $0B, $82, $03         ; data? H,  ,  ,                          
          db $0F, $82, $42, $5D         ; data?  ,  , B, ]                        
          db $27, $01, $9F, $B8         ; data? ',  ,  ,                          
          db $82, $B7, $82, $1C         ; data?  ,  ,  ,                          
          db $95, $15, $6B, $13         ; data?  ,  , k,                          
          db $6B, $03, $81, $13         ; data? k,  ,  ,                          
          db $06, $82, $05, $05         ; data?  ,  ,  ,                          
          db $82, $04, $14, $6B         ; data?  ,  ,  , k                        
          db $12, $6B, $11, $81         ; data?  , k,  ,                          
          db $A6, $05, $B7, $8A         ; data?  ,  ,  ,                          
          db $1C, $82, $81, $07         ; data?  ,  ,  ,                          
          db $82, $0C, $AE, $AF         ; data?  ,  ,  ,                          
          db $CD, $37, $C7, $46         ; data?  , 7,  , F                        
          db $24, $09, $14, $6B         ; data? $,  ,  , k                        
          db $20, $07, $05, $82         ; data? SPACE,  ,  ,                      
          db $07, $14, $6B, $12         ; data?  ,  , k,                          
          db $6B, $16, $01, $81         ; data? k,  ,  ,                          
          db $00, $61, $02, $17         ; data?  , a,  ,                          
          db $01, $81                   ; data?  ,  ,  ,                          
; 
L0F3F: 
          lda RAM1_082                  ; Load Accumulator with value of Memory at RAM1_082, A <- (RAM1_082)
...
; 
          ...
          db $5B, $AE, $A0, $CD         ; data? [,  ,  ,                          
          db $10, $A5, $B7, $59         ; data?  ,  ,  , Y                        
          db $AE, $A1, $CD, $10         ; data?  ,  ,  ,                          
          db $A5, $B7, $58, $0A         ; data?  ,  , X,                          
          db $82, $28, $07, $7E         ; data?  , (,  , ~                        
          db $25, $17, $7E, $2B         ; data? %,  , ~, +                        
          ...
          db $26, $04, $A0, $0D         ; data? &,  ,  ,                          
          db $AB, $07, $CD, $25         ; data?  ,  ,  , %                        
          db $2C, $BB, $50, $B7         ; data? ,,  , P,                          
          db $50, $A6, $03, $CD         ; data? P,  ,  ,                          
          db $0F, $79, $B6, $58         ; data?  , y,  , X                        
          ...
          db $2A, $01, $40, $CD         ; data? *,  , @,                          
          db $25, $2C, $BB, $57         ; data? %, ,,  , W                        
          db $97, $D6, $10, $ED         ; data?  ,  ,  ,                          
          db $0F, $59, $03, $CD         ; data?  , Y,  ,                          
          db $25, $2C, $CD, $25         ; data? %, ,,  , %                        
          db $25, $06, $57, $0E         ; data? %,  , W,                          
          db $0E, $5B, $0A, $40         ; data?  , [,  , @                        
          db $27, $07, $BB, $56         ; data? ',  ,  , V                        
          db $25, $0A, $4F, $20         ; data? %,  , O, SPACE                    
          db $07, $4F, $BB, $56         ; data?  , O,  , V                        
          db $24, $02, $A6, $FF         ; data? $,  ,  ,                          
          db $B7, $50, $A6, $02         ; data?  , P,  ,                          
          db $CD, $0F, $79, $09         ; data?  ,  , y,                          
          db $7E, $60, $19, $7E         ; data? ~, `,  , ~                        
          db $A6, $88, $B7, $55         ; data?  ,  ,  , U                        
          db $A6, $14, $B7, $54         ; data?  ,  ,  , T                        
          db $A6, $E0, $AE, $53         ; data?  ,  ,  , S                        
          db $BF, $57, $BE, $57         ; data?  , W,  , W                        
          db $7F, $B7, $56, $AE         ; data? DEL,  , V,                        
          db $A3, $CD, $37, $C7         ; data?  ,  , 7,                          
X105E: 
          db $0D, $8E, $01, $4F         ; data?  ,  ,  , O                        
          db $B8, $56, $A5, $20         ; data?  , V,  , SPACE                    
          db $26, $0E, $CD, $37         ; data? &,  ,  , 7                        
          db $C7, $0D, $8E, $01         ; data?  ,  ,  ,                          
          db $4F, $2A, $01, $40         ; data? O, *,  , @                        
          db $AB, $10, $AD, $20         ; data?  ,  ,  , SPACE                    
          db $AE, $A2, $CD, $37         ; data?  ,  ,  , 7                        
          db $C7, $B8, $56, $A5         ; data?  ,  , V,                          
          db $40, $27, $08, $CD         ; data? @, ',  ,                          
          db $37, $C7, $2A, $01         ; data? 7,  , *,                          
          db $40, $AD, $0D, $3A         ; data? @,  ,  , :                        
          db $57, $B6, $56, $A0         ; data? W,  , V,                          
          db $20, $2B, $C3, $AE         ; data? SPACE, +,  ,                      
          db $55, $CC, $11, $BB         ; data? U,  ,  ,                          
          db $97, $D6, $11, $91         ; data?  ,  ,  ,                          
          db $BE, $57, $FB, $A1         ; data?  , W,  ,                          
          db $1F, $23, $02, $A6         ; data?  ,  #,  ,                         
          db $1F, $F7, $81, $4F         ; data?  ,  ,  , O                        
          db $0A, $82, $09, $0A         ; data?  ,  ,  ,                          
          db $7F, $3F, $0C, $7F         ; data? DEL,  ,  , DEL                    
          db $3C, $06, $81, $39         ; data? <,  ,  , 9                        
          db $CD, $37, $C7, $AB         ; data?  , 7,  ,                          
          db $06, $2A, $02, $A6         ; data?  , *,  ,                          
          db $06, $A3, $A0, $26         ; data?  ,  ,  , &                        
          db $02, $AB, $0D, $03         ; data?  ,  ,  ,                          
          db $81, $02, $AB, $1A         ; data?  ,  ,  ,                          
          db $97, $D6, $11, $5D         ; data?  ,  ,  , ]                        
          db $2B, $1F, $03, $81         ; data? +,  ,  ,                          
          db $1C, $BE, $56, $A3         ; data?  ,  , V,                          
          db $44, $24, $16, $3F         ; data? D, $,  ,                          
          db $53, $A3, $36, $25         ; data? S,  , 6, %                        
          db $08, $3C, $53, $A3         ; data?  , <, S,                          
          db $3C, $25, $02, $3C         ; data? <, %,  , <                        
          db $53, $B1, $53, $23         ; data? S,  , S,  #                       
          db $04, $B6, $53, $1E         ; data?  ,  , S,                          
          db $5B, $4D, $81, $00         ; data? [, M,  ,                          
          db $00, $70, $72, $62         ; data?  , p, r, b                        
          db $51, $41, $21, $00         ; data? Q, A, !,                          
          db $21, $41, $52, $62         ; data? !, A, R, b                        
          db $72, $70, $00, $00         ; data? r, p,  ,                          
          db $00, $78, $67, $57         ; data?  , x, g, W                        
          db $56, $35, $13, $00         ; data? V, 5,  ,                          
          db $32, $53, $65, $75         ; data? 2, S, e, u                        
          db $76, $86, $00, $00         ; data? v,  ,  ,                          
          db $00, $68, $68, $57         ; data?  , h, h, W                        
          db $46, $35, $13, $00         ; data? F, 5,  ,                          
          db $41, $53, $74, $75         ; data? A, S, t, u                        
          db $85, $86, $00, $00         ; data?  ,  ,  ,                          
          db $00, $69, $58, $58         ; data?  , i, X, X                        
          db $47, $25, $14, $00         ; data? G, %,  ,                          
          db $41, $63, $74, $75         ; data? A, c, t, u                        
          db $85, $86, $00, $00         ; data?  ,  ,  ,                          
          db $00, $59, $58, $48         ; data?  , Y, X, H                        
          db $47, $26, $14, $00         ; data? G, &,  ,                          
          db $41, $63, $74, $84         ; data? A, c, t,                          
          db $85, $95, $00, $00         ; data?  ,  ,  ,                          
          db $00, $59, $58, $48         ; data?  , Y, X, H                        
          db $47, $25, $14, $00         ; data? G, %,  ,                          
          db $41, $62, $74, $84         ; data? A, b, t,                          
          db $85, $95, $00, $00         ; data?  ,  ,  ,                          
          db $00, $59, $58, $48         ; data?  , Y, X, H                        
          db $47, $25, $14, $00         ; data? G, %,  ,                          
          db $41, $62, $74, $84         ; data? A, b, t,                          
...
X1202: 
          db $04, $0C, $00, $00         ; data?  ,  ,  ,                          
          db $49, $AD, $20, $24         ; data? I,  , SPACE, $                    
          db $F4, $F7, $3A, $59         ; data?  ,  , :, Y                        
          db $2B, $07, $AD, $DE         ; data? +,  ,  ,                          
          db $5A, $1F, $04, $20         ; data? Z,  ,  , SPACE                    
          db $E4, $AD, $CE, $98         ; data?  ,  ,  ,                          
          db $AD, $0D, $AD, $D2         ; data?  ,  ,  ,                          
          db $1F, $04, $AD, $02         ; data?  ,  ,  ,                          
          db $1D, $04, $81, $AD         ; data?  ,  ,  ,                          
          db $F7, $AD, $C7, $1E         ; data?  ,  ,  ,                          
          db $04, $1F, $00, $81         ; data?  ,  ,  ,                          
          db $A6, $03, $0A, $7F         ; data?  ,  ,  , DEL                      
          db $12, $0E, $7F, $11         ; data?  ,  , DEL,                        
          db $0C, $87, $0E, $4A         ; data?  ,  ,  , J                        
          db $0C, $7F, $08, $01         ; data?  , DEL,  ,                        
          db $7F, $03, $02, $7C         ; data? DEL,  ,  , |                      
          db $02, $B6, $7F, $3F         ; data?  ,  , DEL,                        
          db $87, $B8, $82, $A4         ; data?  ,  ,  ,                          
          db $03, $81                   ; data?  ,  ,  ,                          
; 
L124C: 
          ...
          rts                           ; Return from Subroutine                  
; 
          db $B7, $57, $CD, $37         ; data?  , W,  , 7                        
          db $C7, $48, $48, $AB         ; data?  , H, H,                          
...
; 
          ...
          db $C1, $CD, $1E, $26         ; data?  ,  ,  , &                        
          db $10, $BA, $CD, $25         ; data?  ,  ,  , %                        
          db $4E, $18, $01, $AE         ; data? N,  ,  ,                          
          db $B0, $CD, $37, $C7         ; data?  ,  , 7,                          
          ...
          db $CD, $13, $BC, $CD         ; data?  ,  ,  ,                          
          db $36, $AE, $CD, $07         ; data? 6,  ,  ,                          
          db $89, $CD, $36, $F2         ; data?  ,  , 6,                          
          db $CD, $13, $E0, $0D         ; data?  ,  ,  ,                          
          db $BA, $06, $1D, $D6         ; data?  ,  ,  ,                          
          db $3D, $63, $26, $E3         ; data? =, c, &,                          
          db $CD, $36, $F2, $CD         ; data?  , 6,  ,                          
          db $1E, $26, $1B, $BA         ; data?  , &,  ,                          
          db $1D, $BA, $81              ; data?  ,  ,  ,                          
; 
L13BC: 
...
; 
          ...
          db $03, $CC, $18, $FF         ; data?  ,  ,  ,                          
          db $05, $C0, $03, $CC         ; data?  ,  ,  ,                          
          db $1C, $56, $B6, $B3         ; data?  , V,  ,                          
          db $26, $07, $CD, $14         ; data? &,  ,  ,                          
          db $94, $CD, $14, $CB         ; data?  ,  ,  ,                          
          db $81, $2B, $3F, $08         ; data?  , +,  ,                          
          db $B3, $19, $A5, $60         ; data?  ,  ,  , `                        
          db $27, $05, $CD, $18         ; data? ',  ,  ,                          
          db $4C, $20, $02, $3F         ; data? L, SPACE,  ,                      
          db $B3, $11, $BA, $0E         ; data?  ,  ,  ,                          
          db $B9, $06, $0D, $BA         ; data?  ,  ,  ,                          
          db $03, $0D, $C1, $02         ; data?  ,  ,  ,                          
          db $10, $BA, $81, $B6         ; data?  ,  ,  ,                          
...
X155D: 
          ...
          db $B6, $56, $CD, $25         ; data?  , V,  , %                        
          db $2C, $CD, $24, $41         ; data? ,,  , $, A                        
...
L1599: 
          ...
          db $69, $C6, $02, $72         ; data? i,  ,  , r                        
          db $CD, $15, $69, $1C         ; data?  ,  , i,                          
          db $CB, $CC, $16, $BF         ; data?  ,  ,  ,                          
          db $BE, $5B, $A3, $08         ; data?  , [,  ,                          
          db $27, $0D, $A3, $0B         ; data? ',  ,  ,                          
          db $26, $F3, $0D, $CE         ; data? &,  ,  ,                          
          ...
          db $07, $97, $DE, $17         ; data?  ,  ,  ,                          
          db $20, $1F, $BA, $DD         ; data? SPACE,  ,  ,                      
          db $17, $26, $20, $16         ; data?  , &, SPACE,                      
          db $1A, $CB, $27, $12         ; data?  ,  , ',                          
          db $B8, $B9, $B7, $B9         ; data?  ,  ,  ,                          
          db $04, $B8, $0B, $07         ; data?  ,  ,  ,                          
          db $B9, $08, $AE, $B2         ; data?  ,  ,  ,                          
          db $CD, $37, $C7, $CD         ; data?  , 7,  ,                          
          db $1D, $EE, $1C, $D6         ; data?  ,  ,  ,                          
          db $81, $00, $BF, $E2         ; data?  ,  ,  ,                          
          ...
          db $B8, $04, $B8, $0D         ; data?  ,  ,  ,                          
          db $11, $B8, $A6, $FF         ; data?  ,  ,  ,                          
          db $AE, $BC, $CD, $37         ; data?  ,  ,  , 7                        
          db $9B, $5C, $CD, $37         ; data?  , \,  , 7                        
          db $9B, $A6, $80, $B7         ; data?  ,  ,  ,                          
          db $B3, $81, $CC, $1D         ; data?  ,  ,  ,                          
          db $33, $17, $BF, $0F         ; data? 3,  ,  ,                          
          db $56, $78, $CD, $1C         ; data? V, x,  ,                          
          db $25, $14, $7E, $B6         ; data? %,  , ~,                          
          db $B8, $B7, $BD, $14         ; data?  ,  ,  ,                          
          db $BB, $1D, $BC, $81         ; data?  ,  ,  ,                          
          db $19, $BB, $0C, $56         ; data?  ,  ,  , V                        
          db $0C, $1D, $BC, $15         ; data?  ,  ,  ,                          
          db $BB, $1D, $B8, $1B         ; data?  ,  ,  ,                          
          db $B8, $19, $B8, $20         ; data?  ,  ,  , SPACE                    
          db $57, $B6, $B8, $0C         ; data? W,  ,  ,                          
          db $BC, $04, $A5, $70         ; data?  ,  ,  , p                        
          db $26, $50, $A4, $0C         ; data? &, P,  ,                          
          db $B7, $BD, $C6, $02         ; data?  ,  ,  ,                          
          db $72, $A0, $06, $27         ; data? r,  ,  , '                        
          db $09, $2B, $05, $4A         ; data?  , +,  , J                        
          db $3C, $BD, $20, $F5         ; data? <,  , SPACE,                      
          db $AB, $07, $CD, $25         ; data?  ,  ,  , %                        
          db $2C, $BB, $BD, $B7         ; data? ,,  ,  ,                          
          db $BD, $05, $B8, $09         ; data?  ,  ,  ,                          
          db $CD, $25, $2D, $B8         ; data?  , %, -,                          
          db $B8, $A4, $08, $20         ; data?  ,  ,  , SPACE                    
          db $0B, $0B, $69, $04         ; data?  ,  , i,                          
          db $A5, $01, $26, $12         ; data?  ,  , &,                          
          db $B8, $B8, $A4, $03         ; data?  ,  ,  ,                          
          db $27, $10, $0D, $BC         ; data? ',  ,  ,                          
          db $06, $1D, $B8, $1B         ; data?  ,  ,  ,                          
          ...
          db $12, $BA, $16, $BC         ; data?  ,  ,  ,                          
          db $A6, $E3, $08, $C1         ; data?  ,  ,  ,                          
          db $06, $AE, $01, $20         ; data?  ,  ,  , SPACE                    
          db $04, $A6, $60, $AE         ; data?  ,  , `,                          
          db $28, $CC, $1C, $2D         ; data? (,  ,  , -                        
          db $05, $C1, $F6, $1A         ; data?  ,  ,  ,                          
          db $C1, $81, $0B, $B6         ; data?  ,  ,  ,                          
          db $05, $CD, $1D, $33         ; data?  ,  ,  , 3                        
          db $20, $1A, $B6, $B6         ; data? SPACE,  ,  ,                      
          db $A4, $07, $A1, $05         ; data?  ,  ,  ,                          
          db $27, $0B, $A1, $04         ; data? ',  ,  ,                          
          db $26, $0E, $0D, $B5         ; data? &,  ,  ,                          
          db $0B, $3F, $C2, $10         ; data?  ,  ,  ,                          
          db $B6, $34, $C2, $26         ; data?  , 4,  , &                        
          db $03, $CD, $1C, $F4         ; data?  ,  ,  ,                          
          db $1E, $BA, $B6, $B6         ; data?  ,  ,  ,                          
          db $AA, $D0, $A5, $20         ; data?  ,  ,  , SPACE                    
          db $27, $02, $A4, $A7         ; data? ',  ,  ,                          
          db $B7, $B3, $81, $B6         ; data?  ,  ,  ,                          
          db $B3, $A5, $0F, $27         ; data?  ,  ,  , '                        
          db $72, $A4, $07, $97         ; data? r,  ,  ,                          
          db $4F, $99, $49, $5A         ; data? O,  , I, Z                        
          db $2A, $FC, $B7, $56         ; data? *,  ,  , V                        
          db $AE, $B5, $07, $B3         ; data?  ,  ,  ,                          
          db $02, $AE, $BC, $0D         ; data?  ,  ,  ,                          
          db $B3, $09, $0A, $B3         ; data?  ,  ,  ,                          
          db $04, $43, $F4, $20         ; data?  , C,  , SPACE                    
          db $03, $F8, $B1, $FA         ; data?  ,  ,  ,                          
          db $06, $B3, $09, $03         ; data?  ,  ,  ,                          
          db $56, $06, $A5, $02         ; data? V,  ,  ,                          
          db $27, $02, $AA, $0C         ; data? ',  ,  ,                          
          db $07, $8E, $0F, $09         ; data?  ,  ,  ,                          
          ...
          db $A5, $08, $26, $02         ; data?  ,  , &,                          
          db $A4, $AF, $F7, $AE         ; data?  ,  ,  ,                          
          db $F3, $06, $B3, $46         ; data?  ,  ,  , F                        
          db $A4, $62, $AE, $B0         ; data?  , b,  ,                          
          db $CD, $37, $9B, $1A         ; data?  , 7,  ,                          
          db $CB, $0A, $56, $06         ; data?  ,  , V,                          
          db $0D, $56, $51, $04         ; data?  , V, Q,                          
          db $B8, $0C, $B6, $B6         ; data?  ,  ,  ,                          
          db $A4, $17, $A1, $04         ; data?  ,  ,  ,                          
          db $26, $04, $AD, $8C         ; data? &,  ,  ,                          
          db $20, $4C, $0D, $56         ; data? SPACE, L,  , V                    
          db $3F, $AE, $10, $A1         ; data?  ,  ,  ,                          
          db $05, $27, $3E, $0C         ; data?  , ', >,                          
          db $59, $07, $AE, $F1         ; data? Y,  ,  ,                          
          db $0C, $B9, $36, $20         ; data?  ,  , 6, SPACE                    
          db $2F, $18, $C0, $17         ; data? /,  ,  ,                          
          db $C0, $05                   ; data?  ,  ,  ,                          
X18CB: 
          db $B8, $11, $16, $C0         ; data?  ,  ,  ,                          
          db $AE, $B2, $CD, $37         ; data?  ,  ,  , 7                        
          db $C7, $B7, $B8, $1B         ; data?  ,  ,  ,                          
          db $BB, $CC, $17, $62         ; data?  ,  ,  , b                        
          db $CC, $1A, $4E, $0C         ; data?  ,  , N,                          
          db $C1, $14, $CD, $1E         ; data?  ,  ,  ,                          
          db $12, $26, $0F, $A6         ; data?  , &,  ,                          
          db $01, $B7, $C3, $B6         ; data?  ,  ,  ,                          
          db $C1, $A1, $95, $27         ; data?  ,  ,  , '                        
          ...
          db $BA, $02, $A4, $BF         ; data?  ,  ,  ,                          
          db $AA, $08, $AA, $04         ; data?  ,  ,  ,                          
          db $A4, $4E, $0F, $B5         ; data?  , N,  ,                          
          db $05, $06, $B5, $02         ; data?  ,  ,  ,                          
          db $A4, $4A, $0D, $CE         ; data?  , J,  ,                          
          db $02, $AA, $30, $08         ; data?  ,  , 0,                          
          db $CE, $03, $07, $CE         ; data?  ,  ,  ,                          
          db $02, $AA, $10, $4C         ; data?  ,  ,  , L                        
          db $A5, $04, $27, $0D         ; data?  ,  , ',                          
          db $06, $5D, $03, $07         ; data?  , ],  ,                          
          db $BF, $02, $A4, $F3         ; data?  ,  ,  ,                          
          db $0F, $BF, $02, $A4         ; data?  ,  ,  ,                          
          ...
          db $8E, $06, $AA, $02         ; data?  ,  ,  ,                          
          db $A4, $BB, $AE, $09         ; data?  ,  ,  ,                          
          db $01, $61, $0F, $03         ; data?  , a,  ,                          
          db $82, $07, $00, $82         ; data?  ,  ,  ,                          
          db $04, $AA, $80, $20         ; data?  ,  ,  , SPACE                    
          db $05, $09, $69, $02         ; data?  ,  , i,                          
          db $AA, $40, $C7, $02         ; data?  , @,  ,                          
          db $7C, $9F, $0D, $5F         ; data? |,  ,  , _                        
          db $02, $AA, $40, $13         ; data?  ,  , @,                          
          db $BC, $AA, $80, $09         ; data?  ,  ,  ,                          
          db $BF, $07, $0E, $B5         ; data?  ,  ,  ,                          
          db $04, $12, $BC, $A4         ; data?  ,  ,  ,                          
          db $7F, $C7, $02, $7D         ; data? DEL,  ,  , }                      
          db $A6, $20, $05, $B8         ; data?  , SPACE,  ,                      
          db $05, $0C, $5F, $02         ; data?  ,  , _,                          
          db $A6, $02, $AA, $10         ; data?  ,  ,  ,                          
          db $14, $B5, $97, $17         ; data?  ,  ,  ,                          
          db $BC, $A6, $0A, $CC         ; data?  ,  ,  ,                          
          db $1A, $21, $7B, $78         ; data?  , !, {, x                        
          db $00, $5B, $D9, $BE         ; data?  , [,  ,                          
          db $CD, $F2, $17, $5D         ; data?  ,  ,  , ]                        
          db $B6, $B8, $A4, $74         ; data?  ,  ,  , t                        
          db $A1, $60, $27, $3C         ; data?  , `, ', <                        
          db $AE, $02, $A1, $10         ; data?  ,  ,  ,                          
          db $26, $04, $16, $BF         ; data? &,  ,  ,                          
          db $20, $2E, $AE, $83         ; data? SPACE, .,  ,                      
          db $A1, $50, $27, $28         ; data?  , P, ', (                        
          db $5F, $05, $B8, $05         ; data? _,  ,  ,                          
          db $07, $B8, $07, $20         ; data?  ,  ,  , SPACE                    
          db $03, $03, $B8, $02         ; data?  ,  ,  ,                          
          db $AE, $04, $A4, $70         ; data?  ,  ,  , p                        
          db $A1, $20, $27, $0E         ; data?  , SPACE, ',                      
          db $04, $B8, $0A, $5C         ; data?  ,  ,  , \                        
          db $A1, $30, $27, $06         ; data?  , 0, ',                          
          db $5C, $A1, $40, $27         ; data? \,  , @, '                        
          db $01, $81, $58, $58         ; data?  ,  , X, X                        
          db $99, $59, $99, $59         ; data?  , Y,  , Y                        
          db $A6, $18, $20, $4A         ; data?  ,  , SPACE, J                    
          db $B6, $88, $44, $B7         ; data?  ,  , D,                          
          db $56, $B6, $83, $48         ; data? V,  ,  , H                        
          db $BB, $56, $AE, $70         ; data?  , V,  , p                        
          db $CD, $37, $86, $CC         ; data?  , 7,  ,                          
          db $17, $6F, $07, $B3         ; data?  , o,  ,                          
          db $A5, $3F, $B6, $0D         ; data?  ,  ,  ,                          
          db $B3, $0F, $0B, $B3         ; data?  ,  ,  ,                          
          db $06, $AE, $09, $3F         ; data?  ,  ,  ,                          
          db $B3, $20, $24, $AE         ; data?  , SPACE, $,                      
          db $EA, $BF, $B3, $20         ; data?  ,  ,  , SPACE                    
          db $19, $1B, $BC, $1D         ; data?  ,  ,  ,                          
          db $BC, $16, $94, $CD         ; data?  ,  ,  ,                          
          db $1D, $9B, $AA, $80         ; data?  ,  ,  ,                          
          db $06, $B5, $04, $43         ; data?  ,  ,  , C                        
          db $B4, $56, $C1, $BA         ; data?  , V,  ,                          
          db $56, $BE, $57, $CD         ; data? V,  , W,                          
          db $37, $9B, $CD, $1D         ; data? 7,  ,  ,                          
          db $D2, $AE, $89, $CD         ; data?  ,  ,  ,                          
          db $1D, $AF, $B7, $50         ; data?  ,  ,  , P                        
          db $BF, $51, $0F, $D6         ; data?  , Q,  ,                          
          db $0D, $CD, $07, $89         ; data?  ,  ,  ,                          
          db $07, $67, $F7, $17         ; data?  , g,  ,                          
          db $67, $CD, $36, $AE         ; data? g,  , 6,                          
          db $20, $F0, $B6, $50         ; data? SPACE,  ,  , P                    
          db $BE, $51, $C7, $02         ; data?  , Q,  ,                          
          db $7A, $CF, $02, $7B         ; data? z,  ,  , {                        
          db $1E, $D6, $3F, $D9         ; data?  ,  ,  ,                          
          db $81, $07, $B3, $07         ; data?  ,  ,  ,                          
          db $0E, $BA, $82, $AE         ; data?  ,  ,  ,                          
          db $0A, $20, $85              ; data?  , SPACE,  ,                      
; 
L1A4E: 
...
; 
          ...
          db $BF, $1B, $BB, $19         ; data?  ,  ,  ,                          
          db $BB, $07, $B3, $16         ; data?  ,  ,  ,                          
          db $AE, $B1, $CD, $37         ; data?  ,  ,  , 7                        
          db $C7, $0B, $B6, $07         ; data?  ,  ,  ,                          
          db $A5, $70, $26, $05         ; data?  , p, &,                          
          db $CC, $1D, $4E, $AA         ; data?  ,  , N,                          
          db $70, $B7, $B8, $04         ; data? p,  ,  ,                          
          db $B8, $00, $1F, $BF         ; data?  ,  ,  ,                          
          db $B6, $B8, $A4, $70         ; data?  ,  ,  , p                        
          db $A1, $70, $26, $03         ; data?  , p, &,                          
          db $CD, $1D, $73, $CD         ; data?  ,  , s,                          
          db $1D, $9B, $10, $56         ; data?  ,  ,  , V                        
          ...
          db $3F, $C1, $16, $BC         ; data?  ,  ,  ,                          
          db $CC, $1D, $D2, $CD         ; data?  ,  ,  ,                          
          db $17, $62, $CC, $1A         ; data?  , b,  ,                          
          db $83, $B6, $B8, $B7         ; data?  ,  ,  ,                          
          db $BD, $BE, $C1, $CC         ; data?  ,  ,  ,                          
          db $1D, $E1, $A6, $64         ; data?  ,  ,  , d                        
          db $C7, $02, $7C, $A6         ; data?  ,  , |,                          
          db $19, $1D, $B8, $1B         ; data?  ,  ,  ,                          
          db $B8, $19, $B8, $1A         ; data?  ,  ,  ,                          
          db $BC, $16, $B5, $17         ; data?  ,  ,  ,                          
          ...
          db $AD, $E6, $1B, $B5         ; data?  ,  ,  ,                          
          db $06, $CE, $0A, $AE         ; data?  ,  ,  ,                          
          db $AC, $CD, $37, $C7         ; data?  ,  , 7,                          
          db $46, $24, $02, $1A         ; data? F, $,  ,                          
          db $B5, $CD, $1E, $35         ; data?  ,  ,  , 5                        
          db $B8, $C0, $A4, $03         ; data?  ,  ,  ,                          
          db $B8, $C0, $B7, $C0         ; data?  ,  ,  ,                          
          ...
          db $C1, $03, $CC, $18         ; data?  ,  ,  ,                          
          db $0E, $A6, $C3, $CC         ; data?  ,  ,  ,                          
          db $1C, $43, $AD, $09         ; data?  , C,  ,                          
          db $B8, $B8, $A4, $70         ; data?  ,  ,  , p                        
          db $B8, $B8, $B7, $B8         ; data?  ,  ,  ,                          
          db $81, $AD, $0D, $AB         ; data?  ,  ,  ,                          
          db $B3, $CD, $37, $C6         ; data?  ,  , 7,                          
          ...
          db $CD, $37, $C6, $B7         ; data?  , 7,  ,                          
          db $56, $B6, $B8, $CD         ; data? V,  ,  ,                          
          db $25, $25, $CD, $25         ; data? %, %,  , %                        
          db $72, $81, $B6, $B8         ; data? r,  ,  ,                          
          db $48, $CD, $25, $24         ; data? H,  , %, $                        
          db $26, $02, $A6, $07         ; data? &,  ,  ,                          
...
; 
          ...
          db $0D, $C7, $5C, $A4         ; data?  ,  , \,                          
          db $0E, $97, $D6, $1F         ; data?  ,  ,  ,                          
          db $83, $B7, $59, $D6         ; data?  ,  , Y,                          
          db $1F, $84, $B7, $56         ; data?  ,  ,  , V                        
          db $54, $D6, $1F, $93         ; data? T,  ,  ,                          
          db $C7, $02, $56, $A4         ; data?  ,  , V,                          
          db $0F, $27, $13, $4A         ; data?  , ',  , J                        
          db $B7, $58, $CE, $1F         ; data?  , X,  ,                          
          db $82, $BF, $57, $C6         ; data?  ,  , W,                          
          db $1F, $81, $4D, $27         ; data?  ,  , M, '                        
          ...
          db $50, $4C, $CD, $25         ; data? P, L,  , %                        
          db $2C, $C7, $02, $57         ; data? ,,  ,  , W                        
          db $9F, $A4, $0F, $CB         ; data?  ,  ,  ,                          
...
; 
          db $04, $01, $14, $14         ; data?  ,  ,  ,                          
          db $01, $AE, $08, $20         ; data?  ,  ,  , SPACE                    
          db $0C                        ; data?  ,  ,  ,                          
; 
L1FFF: 
          brset 0,PortC,L000D           ; Branch to 0x000D if ENA_8V is HIGH      
          ...
          rts                           ; Return from Subroutine                  
; 
          db $19, $61, $11, $81         ; data?  , a,  ,                          
          db $04, $12, $03, $05         ; data?  ,  ,  ,                          
          db $01, $0A, $AE, $32         ; data?  ,  ,  , 2                        
          db $AD, $26, $15, $01         ; data?  , &,  ,                          
          db $AE, $05, $AD, $20         ; data?  ,  ,  , SPACE                    
          db $9A, $81, $A6, $04         ; data?  ,  ,  ,                          
          db $CD, $25, $41, $3F         ; data?  , %, A,                          
          db $0F, $A6, $07, $B7         ; data?  ,  ,  ,                          
          db $04, $3F, $00, $1D         ; data?  ,  ,  ,                          
          db $01, $1B, $61, $01         ; data?  ,  , a,                          
          db $02, $EA, $11, $02         ; data?  ,  ,  ,                          
          db $09, $0C, $26, $AE         ; data?  ,  , &,                          
          db $32, $AD, $01, $81         ; data? 2,  ,  ,                          
; 
L204F: 
          sei                           ; Set Interrupt Mask, I ← 1);           
          bclr 7,RAM1_08f               ; Clear bit 7 at RAM1_08f                 
          brclr 1,PortC,L0058           ; Branch to 0x0058 if WDOG_TEL is LOW     
          bclr 1,PortC                  ; Set WDOG_TEL LOW                        
          ...
          bset 4,RAM1_05e               ; Set Bit 4 at memory RAM1_05e (Mn <- 1 ) 
          bset 7,RAM1_096               ; Set Bit 7 at memory RAM1_096 (Mn <- 1 ) 
          brclr 0,PortC,L006F           ; Branch to 0x006F if ENA_8V is LOW       
...
; 
L207E: 
          brclr 5,DDRB,L009C            ; Branch to 0x009C if RESET_SLAVE is set to INPUT
...
X213B: 
          ...
          db $2C, $07, $2C, $00         ; data? ,,  , ,,                          
          db $A6, $02, $B8, $12         ; data?  ,  ,  ,                          
          db $B7, $12, $16, $76         ; data?  ,  ,  , v                        
          db $B6, $14, $B7, $6D         ; data?  ,  ,  , m                        
          db $B6, $15, $B7, $6E         ; data?  ,  ,  , n                        
          db $09, $5E, $05, $02         ; data?  , ^,  ,                          
          db $12, $31, $20, $1C         ; data?  , 1, SPACE,                      
...
L2223: 
          ...
          rts                           ; Return from Subroutine                  
; 
          db $4F, $C7, $02, $AA         ; data? O,  ,  ,                          
          db $AE, $0D, $CD, $23         ; data?  ,  ,  ,  #                       
          db $9D, $B6, $75, $CB         ; data?  ,  , u,                          
          db $02, $AE, $C7, $02         ; data?  ,  ,  ,                          
          db $AE, $4F, $C9, $02         ; data?  , O,  ,                          
          db $AD, $C7, $02, $AD         ; data?  ,  ,  ,                          
          db $C6, $02, $AE, $CE         ; data?  ,  ,  ,                          
          db $02, $AD, $56, $46         ; data?  ,  , V, F                        
          db $56, $46, $56, $46         ; data? V, F, V, F                        
          db $AE, $0B, $CD, $23         ; data?  ,  ,  ,  #                       
          db $C2, $25, $4B, $AE         ; data?  , %, K,                          
          db $19, $CD, $23, $2C         ; data?  ,  ,  #, ,                       
          db $20, $34, $04, $76         ; data? SPACE, 4,  , v                    
          db $CB, $AE, $06, $CD         ; data?  ,  ,  ,                          
          db $23, $9D, $CD, $23         ; data?  #,  ,  ,  #                      
          db $9B, $AE, $03, $E6         ; data?  ,  ,  ,                          
          db $50, $DB, $02, $A6         ; data? P,  ,  ,                          
          db $D7, $02, $A6, $E7         ; data?  ,  ,  ,                          
          db $56, $E6, $4F, $D9         ; data? V,  , O,                          
          db $02, $A5, $D7, $02         ; data?  ,  ,  ,                          
          db $A5, $E7, $55, $5A         ; data?  ,  , U, Z                        
          db $5A, $2A, $E8, $CD         ; data? Z, *,  ,                          
          db $24, $F2, $AE, $06         ; data? $,  ,  ,                          
          db $CD, $23, $C1, $25         ; data?  ,  #,  , %                       
          db $15, $AE, $0F, $CD         ; data?  ,  ,  ,                          
          db $23, $2C, $A6, $24         ; data?  #, ,,  , $                       
          db $CD, $23, $4D, $C7         ; data?  ,  #, M,                         
          db $02, $AB, $A6, $2A         ; data?  ,  ,  , *                        
          db $CD, $23, $4D, $C7         ; data?  ,  #, M,                         
          db $02, $AC, $01, $61         ; data?  ,  ,  , a                        
          db $28, $C6, $02, $AB         ; data? (,  ,  ,                          
          db $BE, $0A, $CD, $23         ; data?  ,  ,  ,  #                       
          db $7C, $B7, $0A, $C6         ; data? |,  ,  ,                          
          db $02, $AC, $BE, $6C         ; data?  ,  ,  , l                        
          db $CD, $23, $7C, $97         ; data?  ,  #, |,                         
          db $02, $76, $0C, $C6         ; data?  , v,  ,                          
          db $02, $AC, $B0, $6C         ; data?  ,  ,  , l                        
          db $24, $01, $40, $A4         ; data? $,  , @,                          
          db $FC, $27, $06, $13         ; data?  , ',  ,                          
          db $76, $BF, $6C, $12         ; data? v,  , l,                          
          db $5D, $81                   ; data? ],  ,  ,                          
; 
L232C: 
          lda #$05                      ; Load Accumulator with 0x05, A <- 0x05   
...
cpx #$FF 
          ...
          rts                           ; Return from Subroutine                  
; 
          db $AE, $5F, $C1, $AE         ; data?  , _,  ,                          
          db $20, $1B, $C5, $20         ; data? SPACE,  ,  , SPACE                
          db $09                        ; data?  ,  ,  ,                          
; 
L23F3: 
...
; 
          ...
          db $C6, $5C, $81, $5F         ; data?  , \,  , _                        
          db $A6, $00, $AD, $EC         ; data?  ,  ,  ,                          
          db $A3, $06, $26, $F8         ; data?  ,  , &,                          
          db $81, $AE, $01, $AD         ; data?  ,  ,  ,                          
          db $E3, $B6, $56, $AA         ; data?  ,  , V,                          
          db $40, $0B, $69, $01         ; data? @,  , i,                          
          db $4F, $04, $B8, $05         ; data? O,  ,  ,                          
          db $0D, $B5, $02, $AA         ; data?  ,  ,  ,                          
          db $04, $AD, $E3, $5F         ; data?  ,  ,  , _                        
          db $A6, $00, $20, $CC         ; data?  ,  , SPACE,                      
          db $B7, $56, $AD, $06         ; data?  , V,  ,                          
          db $97, $B6, $56, $CD         ; data?  ,  , V,                          
          db $25, $2C, $CD, $25         ; data? %, ,,  , %                        
          db $25, $A1, $0A, $25         ; data? %,  ,  , %                        
          db $02, $AB, $07, $AB         ; data?  ,  ,  ,                          
          db $30, $81, $A6, $68         ; data? 0,  ,  , h                        
          db $C1, $A6, $70, $C1         ; data?  ,  , p,                          
          db $A6, $60, $C1, $A6         ; data?  , `,  ,                          
          db $78, $C1, $A6, $80         ; data? x,  ,  ,                          
          db $4A, $B7, $56, $AE         ; data? J,  , V,                          
          db $07, $BF, $57, $BE         ; data?  ,  , W,                          
          db $56, $D6, $25, $B3         ; data? V,  , %,                          
          db $3A, $56, $BE, $57         ; data? :, V,  , W                        
          db $D7, $02, $57, $3A         ; data?  ,  , W, :                        
          db $57, $2A, $F0, $81         ; data? W, *,  ,                          
          db $02, $CB, $0B, $3C         ; data?  ,  ,  , <                        
          db $CC, $3D, $CC, $27         ; data?  , =,  , '                        
          db $03, $3A, $CC, $81         ; data?  , :,  ,                          
          db $3A, $CC                   ; data? :,  ,  ,                          
...
; 
          db $AE, $D1, $CD, $25         ; data?  ,  ,  , %                        
          db $6C, $26, $02, $1F         ; data? l, &,  ,                          
          db $D2, $AE, $CF, $CD         ; data?  ,  ,  ,                          
          db $25, $6C, $26, $EF         ; data? %, l, &,                          
          db $07, $CE, $02, $1E         ; data?  ,  ,  ,                          
...
; 
          ...
          db $CC, $29, $76, $CC         ; data?  , ), v,                          
          db $2A, $1F, $04, $B6         ; data? *,  ,  ,                          
          db $06, $06, $8E, $13         ; data?  ,  ,  ,                          
          db $05, $B8, $17, $81         ; data?  ,  ,  ,                          
          db $A6, $19, $02, $B5         ; data?  ,  ,  ,                          
          db $02, $A6, $18, $CD         ; data?  ,  ,  ,                          
          db $23, $F3, $A6, $61         ; data?  #,  ,  , a                       
          db $CC, $29, $62, $1C         ; data?  , ), b,                          
          db $C5, $A6, $63, $CC         ; data?  ,  , c,                          
          db $29, $64, $CC, $29         ; data? ), d,  , )                        
          db $9C, $1E, $D2, $AE         ; data?  ,  ,  ,                          
          ...
          db $81, $A6, $08, $04         ; data?  ,  ,  ,                          
          db $B8, $12, $AE, $D4         ; data?  ,  ,  ,                          
          db $CD, $37, $C7, $B7         ; data?  , 7,  ,                          
          db $5B, $B6, $B8, $CD         ; data? [,  ,  ,                          
          db $37, $9B, $B8, $5B         ; data? 7,  ,  , [                        
          db $A4, $01, $AA, $02         ; data?  ,  ,  ,                          
          db $CC, $28, $94, $1E         ; data?  , (,  ,                          
          ...
          db $D2, $B7, $B3, $CC         ; data?  ,  ,  ,                          
          db $2A, $15, $A6, $8A         ; data? *,  ,  ,                          
          db $CD, $2A, $41, $1B         ; data?  , *, A,                          
          db $D2, $1E, $7E, $A6         ; data?  ,  , ~,                          
          db $90, $B7, $77, $81         ; data?  ,  , w,                          
          db $1A, $7E, $0B, $D2         ; data?  , ~,  ,                          
          db $FA, $13, $CB, $A6         ; data?  ,  ,  ,                          
          db $80, $CD, $2A, $41         ; data?  ,  , *, A                        
          ...
          db $19, $02, $CE, $16         ; data?  ,  ,  ,                          
          db $00, $CE, $13, $CD         ; data?  ,  ,  ,                          
          db $1D, $9B, $B4, $56         ; data?  ,  ,  , V                        
          db $27, $0C, $1F, $B5         ; data? ',  ,  ,                          
          db $C1, $BF, $B3, $20         ; data?  ,  ,  , SPACE                    
          db $05, $A6, $80, $CD         ; data?  ,  ,  ,                          
          db $2A, $41, $14, $CE         ; data? *, A,  ,                          
          db $13, $CE, $11, $CE         ; data?  ,  ,  ,                          
          db $A6, $7D, $B7, $CF         ; data?  , },  ,                          
          db $07, $CE, $06, $13         ; data?  ,  ,  ,                          
          ...
          db $A4, $2F, $CD, $24         ; data?  , /,  , $                        
          db $03, $4F, $5C, $05         ; data?  , O, \,                          
          db $BB, $07, $B6, $BD         ; data?  ,  ,  ,                          
          db $A4, $70, $CD, $25         ; data?  , p,  , %                        
          db $25, $CD, $24, $03         ; data? %,  , $,                          
...
; 
          ...
          db $0C, $09, $7F, $09         ; data?  ,  , DEL,                        
          db $19, $7F, $AE, $A8         ; data?  , DEL,  ,                        
          db $CD, $37, $C7, $B7         ; data?  , 7,  ,                          
          db $85, $01, $61, $5D         ; data?  ,  , a, ]                        
          db $3D, $5B, $27, $27         ; data? =, [, ', '                        
          db $1E, $5D, $10, $CB         ; data?  , ],  ,                          
          db $16, $7E, $14, $CB         ; data?  , ~,  ,                          
          db $06, $CE, $4F, $07         ; data?  ,  , O,                          
          db $5B, $08, $1E, $5D         ; data? [,  ,  , ]                        
          db $10, $CB, $18, $B3         ; data?  ,  ,  ,                          
          db $1F, $D2, $0D, $5B         ; data?  ,  ,  , [                        
          db $0E, $1E, $5D, $0C         ; data?  ,  , ],                          
          db $7F, $09, $AE, $A8         ; data? DEL,  ,  ,                        
          db $CD, $37, $C7, $B7         ; data?  , 7,  ,                          
          db $85, $20, $00, $0B         ; data?  , SPACE,  ,                      
          db $7C, $30, $0C, $7C         ; data? |, 0,  , |                        
          db $19, $05, $69, $2A         ; data?  ,  , i, *                        
          db $15, $69, $15, $D2         ; data?  , i,  ,                          
          db $19, $D3, $AE, $A5         ; data?  ,  ,  ,                          
          db $CD, $37, $9B, $02         ; data?  , 7,  ,                          
          db $7F, $1C, $01, $7F         ; data? DEL,  ,  , DEL                    
          db $19, $04, $81, $12         ; data?  ,  ,  ,                          
          db $20, $2E, $04, $69         ; data? SPACE, .,  , i                    
          db $11, $14, $69, $14         ; data?  ,  , i,                          
          db $81, $03, $7F, $02         ; data?  ,  , DEL,                        
          db $15, $81, $14, $CB         ; data?  ,  ,  ,                          
          db $18, $B3, $CC, $2E         ; data?  ,  ,  , .                        
          db $5F, $81, $B6, $7F         ; data? _,  ,  , DEL                      
          db $00, $80, $04, $A5         ; data?  ,  ,  ,                          
          db $EA, $27, $4A, $A5         ; data?  , ', J,                          
          db $03, $26, $10, $03         ; data?  , &,  ,                          
          db $D2, $52, $00, $D2         ; data?  , R,  ,                          
          db $4F, $10, $D2, $AE         ; data? O,  ,  ,                          
          db $88, $CC, $2D, $CF         ; data?  ,  , -,                          
          db $CC, $2E, $1A, $01         ; data?  , .,  ,                          
          db $7F, $3F, $05, $D2         ; data? DEL,  ,  ,                        
          db $7E, $0A, $7F, $39         ; data? ~,  , DEL, 9                      
          db $07, $5F, $03, $02         ; data?  , _,  ,                          
          db $7C, $75, $0E, $D3         ; data? |, u,  ,                          
          db $72, $1E, $D3, $15         ; data? r,  ,  ,                          
          db $D3, $07, $6A, $02         ; data?  ,  , j,                          
          db $14, $D3, $13, $D3         ; data?  ,  ,  ,                          
          db $03, $7C, $11, $12         ; data?  , |,  ,                          
          db $D3, $10, $D3, $01         ; data?  ,  ,  ,                          
          db $7C, $05, $04, $7C         ; data? |,  ,  , |                        
          db $07, $20, $03, $05         ; data?  , SPACE,  ,                      
          db $7C, $02, $11, $D3         ; data? |,  ,  ,                          
          db $A6, $88, $CC, $2E         ; data?  ,  ,  , .                        
          db $0E, $07, $8B, $09         ; data?  ,  ,  ,                          
          db $0E, $60, $06, $B6         ; data?  , `,  ,                          
          db $CE, $A4, $C8, $27         ; data?  ,  ,  , '                        
          db $0C, $02, $D2, $62         ; data?  ,  ,  , b                        
          db $04, $D2, $03, $07         ; data?  ,  ,  ,                          
          db $7C, $39, $CC, $2E         ; data? |, 9,  , .                        
          db $08, $01, $7F, $14         ; data?  ,  , DEL,                        
          db $02, $D2, $53, $0D         ; data?  ,  , S,                          
          db $7C, $2D, $08, $7C         ; data? |, -,  , |                        
          db $2A, $05, $D2, $54         ; data? *,  ,  , T                        
          db $0E, $D3, $51, $20         ; data?  ,  , Q, SPACE                    
          db $22, $CC, $2C, $DD         ; data? ",  , ,,                          
          db $04, $D2, $7C, $06         ; data?  ,  , |,                          
          db $7C, $79, $0D, $6A         ; data? |, y,  , j                        
          db $8F, $C6, $02, $65         ; data?  ,  ,  , e                        
          db $A4, $F0, $A1, $B0         ; data?  ,  ,  ,                          
          db $27, $07, $07, $D4         ; data? ',  ,  ,                          
          db $04, $17, $D4, $20         ; data?  ,  ,  , SPACE                    
          db $1A, $03, $D2, $17         ; data?  ,  ,  ,                          
          db $00, $D2, $14, $1B         ; data?  ,  ,  ,                          
          db $80, $B6, $85, $26         ; data?  ,  ,  , &                        
          db $02, $1A, $80, $0D         ; data?  ,  ,  ,                          
          db $5D, $75, $07, $8B         ; data? ], u,  ,                          
          db $72, $00, $80, $6F         ; data? r,  ,  , o                        
          db $CC, $30, $12, $12         ; data?  , 0,  ,                          
          db $D2, $11, $D2, $18         ; data?  ,  ,  ,                          
          db $B3, $AE, $8D, $05         ; data?  ,  ,  ,                          
          db $D4, $08, $AE, $83         ; data?  ,  ,  ,                          
          db $20, $04, $AE, $80         ; data? SPACE,  ,  ,                      
          db $13, $D2, $BF, $7D         ; data?  ,  ,  , }                        
          db $1C, $94, $20, $49         ; data?  ,  , SPACE, I                    
          db $14, $D2, $18, $B3         ; data?  ,  ,  ,                          
          db $13, $7F, $10, $7F         ; data?  , DEL,  , DEL                    
          db $06, $D3, $0D, $16         ; data?  ,  ,  ,                          
          db $D3, $A6, $8C, $08         ; data?  ,  ,  ,                          
          db $D3, $27, $A6, $8D         ; data?  , ',  ,                          
          db $10, $7C, $20, $21         ; data?  , |, SPACE, !                    
          db $A6, $8F, $0F, $D3         ; data?  ,  ,  ,                          
          db $1C, $1F, $D3, $B6         ; data?  ,  ,  ,                          
          db $D3, $A4, $07, $0B         ; data?  ,  ,  ,                          
          db $D3, $02, $AA, $08         ; data?  ,  ,  ,                          
          db $97, $D6, $30, $02         ; data?  ,  , 0,                          
          db $05, $D3, $0A, $16         ; data?  ,  ,  ,                          
          db $6A, $20, $08, $A6         ; data? j, SPACE,  ,                      
          db $80, $15, $D2, $17         ; data?  ,  ,  ,                          
          db $7C, $17, $6A, $B7         ; data? |,  , j,                          
          db $7B, $1A, $94, $A1         ; data? {,  ,  ,                          
          db $81, $27, $0A, $20         ; data?  , ',  , SPACE                    
          db $04, $12, $7F, $11         ; data?  ,  , DEL,                        
          db $7F, $1F, $D2, $14         ; data? DEL,  ,  ,                        
          db $CB, $18, $5C, $1E         ; data?  ,  , \,                          
          db $5D, $16, $BC, $81         ; data? ],  ,  ,                          
          db $0D, $7C, $14, $0A         ; data?  , |,  ,                          
          db $7F, $11, $A6, $81         ; data? DEL,  ,  ,                        
          db $20, $DB, $06, $8E         ; data? SPACE,  ,  ,                      
          db $1C, $03, $A1, $03         ; data?  ,  ,  ,                          
          db $07, $D2, $04, $A6         ; data?  ,  ,  ,                          
          db $B0, $B7, $77, $81         ; data?  ,  , w,                          
          db $0B, $7F, $0E, $1B         ; data?  , DEL,  ,                        
          db $7F, $13, $CE, $11         ; data? DEL,  ,  ,                        
          db $CE, $A6, $80, $B7         ; data?  ,  ,  ,                          
          db $A0, $17, $D2, $20         ; data?  ,  ,  , SPACE                    
          db $CC, $06, $7F, $EB         ; data?  ,  , DEL,                        
          db $15, $81, $1C, $C5         ; data?  ,  ,  ,                          
          db $00, $7F, $19, $03         ; data?  , DEL,  ,                        
          db $7F, $BB, $0A, $7C         ; data? DEL,  ,  , |                      
          db $08, $A6, $84, $B7         ; data?  ,  ,  ,                          
          db $7B, $1A, $94, $20         ; data? {,  ,  , SPACE                    
          db $0B, $05, $69, $08         ; data?  ,  , i,                          
          db $10, $7F, $19, $7C         ; data?  , DEL,  , |                      
          db $17, $6A, $20, $0B         ; data?  , j, SPACE,                      
          db $0D, $6A, $A2, $4F         ; data?  , j,  , O                        
          db $C7, $02, $64, $11         ; data?  ,  , d,                          
          db $D4, $11, $7F, $13         ; data?  ,  , DEL,                        
          db $7F, $15, $BA, $20         ; data? DEL,  ,  , SPACE                  
          db $98, $AE, $00, $C1         ; data?  ,  ,  ,                          
          db $AE, $06, $20, $18         ; data?  ,  , SPACE,                      
          db $AE, $06, $0D, $8E         ; data?  ,  ,  ,                          
          db $13, $B6, $CE, $A4         ; data?  ,  ,  ,                          
          db $F8, $B7, $CE, $CD         ; data?  ,  ,  ,                          
          db $24, $59, $A6, $C4         ; data? $, Y,  ,                          
          db $CC, $23, $F6, $AE         ; data?  ,  #,  ,                         
          db $04, $C1, $AE, $02         ; data?  ,  ,  ,                          
          db $0A, $7F, $98, $05         ; data?  , DEL,  ,                        
          db $CE, $11, $03, $CE         ; data?  ,  ,  ,                          
          db $0E, $00, $CE, $0B         ; data?  ,  ,  ,                          
          db $B3, $D0, $26, $07         ; data?  ,  , &,                          
          db $3F, $CF, $10, $CF         ; data?  ,  ,  ,                          
          db $3F, $CC, $81, $0E         ; data?  ,  ,  ,                          
          db $7F, $FC, $0A, $80         ; data? DEL,  ,  ,                        
          db $F9, $B6, $82, $A4         ; data?  ,  ,  ,                          
          db $8F, $27, $25, $A1         ; data?  , ', %,                          
          db $01, $27, $21, $A4         ; data?  , ', !,                          
          db $0F, $27, $1D, $A1         ; data?  , ',  ,                          
          ...
          db $CC, $2F, $C9, $A6         ; data?  , /,  ,                          
          db $01, $C1, $A6, $FF         ; data?  ,  ,  ,                          
          db $AE, $50, $20, $07         ; data?  , P, SPACE,                      
          db $A6, $01, $C1, $A6         ; data?  ,  ,  ,                          
          db $FF, $AE, $30, $BF         ; data?  ,  , 0,                          
          db $77, $20, $62, $B6         ; data? w, SPACE, b,                      
          db $78, $A4, $0F, $AB         ; data? x,  ,  ,                          
          db $F9, $40, $27, $A2         ; data?  , @, ',                          
          db $05, $CE, $56, $03         ; data?  ,  , V,                          
          db $CE, $53, $00, $CE         ; data?  , S,  ,                          
          db $50, $B7, $57, $CD         ; data? P,  , W,                          
          db $2F, $C9, $AD, $37         ; data? /,  ,  , 7                        
          db $22, $26, $CD, $2F         ; data? ", &,  , /                        
          db $EA, $26, $08, $3D         ; data?  , &,  , =                        
          db $63, $26, $C1, $BB         ; data? c, &,  ,                          
          db $57, $20, $13, $2A         ; data? W, SPACE,  , *                    
          db $0B, $BB, $57, $2B         ; data?  ,  , W, +                        
          db $0D, $A6, $28, $B7         ; data?  ,  , (,                          
          db $63, $4F, $20, $06         ; data? c, O, SPACE,                      
          db $BB, $57, $2B, $F5         ; data?  , W, +,                          
          db $27, $F3, $AD, $13         ; data? ',  ,  ,                          
          db $22, $A6, $20, $02         ; data? ",  , SPACE,                      
          db $3F, $56, $AD, $74         ; data?  , V,  , t                        
          db $B6, $56, $CD, $37         ; data?  , V,  , 7                        
          db $9B, $18, $7E, $16         ; data?  ,  , ~,                          
          db $7E, $20, $95, $BE         ; data? ~, SPACE,  ,                      
          db $D0, $58, $B7, $56         ; data?  , X,  , V                        
          db $2A, $02, $40, $5C         ; data? *,  , @, \                        
          db $03, $81, $02, $5C         ; data?  ,  ,  , \                        
          db $5C, $D1, $2F, $B9         ; data? \,  , /,                          
          db $81, $0A, $82, $43         ; data?  ,  ,  , C                        
          db $0E, $87, $40, $0C         ; data?  ,  , @,                          
          db $7F, $03, $0B, $7F         ; data? DEL,  ,  , DEL                    
          db $0D, $08, $7F, $0D         ; data?  ,  , DEL,                        
          db $BE, $86, $B3, $85         ; data?  ,  ,  ,                          
          db $23, $07, $BF, $85         ; data?  #,  ,  ,                         
          db $20, $03, $06, $82         ; data? SPACE,  ,  ,                      
          db $2A, $18, $7F, $BB         ; data? *,  , DEL,                        
          db $85, $2B, $13, $06         ; data?  , +,  ,                          
          db $81, $06, $A1, $1E         ; data?  ,  ,  ,                          
          db $23, $02, $A6, $1E         ; data?  #,  ,  ,                         
          db $0F, $82, $08, $3D         ; data?  ,  ,  , =                        
          db $85, $26, $14, $A6         ; data?  , &,  ,                          
          db $01, $B1, $4F, $B7         ; data?  ,  , O,                          
          db $85, $0C, $7F, $0B         ; data?  ,  , DEL,                        
          db $0E, $7F, $08, $0A         ; data?  , DEL,  ,                        
          db $7F, $05, $06, $81         ; data? DEL,  ,  ,                        
          db $02, $16, $5C, $81         ; data?  ,  , \,                          
          db $06, $06, $05, $05         ; data?  ,  ,  ,                          
          db $06, $06, $05, $05         ; data?  ,  ,  ,                          
          db $0F, $0F, $0F, $0F         ; data?  ,  ,  ,                          
...
; 
          ...
          db $CE, $02, $AE, $22         ; data?  ,  ,  , "                        
          db $D6, $30, $2F, $B7         ; data?  , 0, /,                          
          db $56, $D6, $30, $2E         ; data? V,  , 0, .                        
          db $27, $0B, $CD, $27         ; data? ',  ,  , '                        
          db $97, $26, $F1, $DE         ; data?  , &,  ,                          
          db $30, $2D, $DD, $2E         ; data? 0, -,  , .                        
          db $29, $81, $0D, $64         ; data? ),  ,  , d                        
...
; 
          db $00, $A1, $FC, $CD         ; data?  ,  ,  ,                          
          db $31, $66, $A6, $4C         ; data? 1, f,  , L                        
X30CC: 
          db $AD, $0E, $A6, $A6         ; data?  ,  ,  ,                          
          db $AD, $0A, $A6, $07         ; data?  ,  ,  ,                          
          db $AD, $06, $4F, $CD         ; data?  ,  , O,                          
          db $32, $57, $A6, $0E         ; data? 2, W,  ,                          
...
; 
          ...
          db $AF, $3F, $A1, $AD         ; data?  ,  ,  ,                          
          db $00, $A6, $05, $CC         ; data?  ,  ,  ,                          
          db $32, $57, $B6, $A2         ; data? 2, W,  ,                          
          db $A4, $0F, $27, $71         ; data?  ,  , ', q                        
          db $AD, $EC, $AE, $AD         ; data?  ,  ,  ,                          
          db $CD, $32, $99, $0D         ; data?  , 2,  ,                          
          db $A0, $05, $AE, $A3         ; data?  ,  ,  ,                          
          db $CD, $32, $BD, $CD         ; data?  , 2,  ,                          
          db $32, $E3, $BE, $AE         ; data? 2,  ,  ,                          
          db $BF, $B1, $B3, $AD         ; data?  ,  ,  ,                          
          db $25, $03, $A6, $8A         ; data? %,  ,  ,                          
          db $C1, $A6, $82, $B7         ; data?  ,  ,  ,                          
          db $A1, $A6, $08, $AD         ; data?  ,  ,  ,                          
          ...
          db $A1, $02, $A6, $02         ; data?  ,  ,  ,                          
          db $AD, $99, $A6, $04         ; data?  ,  ,  ,                          
          db $AD, $95, $CD, $33         ; data?  ,  ,  , 3                        
          db $FA, $5F, $AD, $67         ; data?  , _,  , g                        
          ...
          db $7C, $7C, $1D, $A1         ; data? |, |,  ,                          
          db $AD, $00, $F6, $AD         ; data?  ,  ,  ,                          
          db $59, $F6, $CD, $25         ; data? Y,  ,  , %                        
          db $25, $5C, $20, $52         ; data? %, \, SPACE, R                    
; 
L3205: 
...
; 
          ...
          db $31, $E0, $AD, $31         ; data? 1,  ,  , 1                        
          db $17, $02, $CD, $33         ; data?  ,  ,  , 3                        
          db $FA, $08, $02, $ED         ; data?  ,  ,  ,                          
          db $A1, $05, $27, $06         ; data?  ,  , ',                          
          db $0A, $02, $E6, $C1         ; data?  ,  ,  ,                          
          db $A6, $02, $CD, $25         ; data?  ,  ,  , %                        
...
X3320: 
          ...
          db $B8, $27, $98, $CC         ; data?  , ',  ,                          
          db $31, $6B, $02, $A1         ; data? 1, k,  ,                          
          db $03, $CC, $30, $69         ; data?  ,  , 0, i                        
          db $1F, $A1, $A6, $01         ; data?  ,  ,  ,                          
          db $B7, $AF, $81, $B6         ; data?  ,  ,  ,                          
          db $AD, $B0, $B1, $24         ; data?  ,  ,  , $                        
          db $02, $A0, $02, $81         ; data?  ,  ,  ,                          
          db $81, $CD, $31, $5F         ; data?  ,  , 1, _                        
          db $15, $A1, $AE, $50         ; data?  ,  ,  , P                        
          db $CD, $32, $99, $CD         ; data?  , 2,  ,                          
          db $32, $E3, $B6, $52         ; data? 2,  ,  , R                        
...
; 
          ...
          db $0F, $A4, $0F, $B7         ; data?  ,  ,  ,                          
          db $A2, $3F, $A1, $81         ; data?  ,  ,  ,                          
          db $AE, $AD, $CD, $32         ; data?  ,  ,  , 2                        
          db $99, $CC, $32, $E3         ; data?  ,  , 2,                          
...
; 
          ...
          db $07, $D2, $09, $B6         ; data?  ,  ,  ,                          
          db $A2, $A4, $F0, $26         ; data?  ,  ,  , &                        
          db $0E, $CC, $35, $84         ; data?  ,  , 5,                          
          db $5C, $26, $77, $1F         ; data? \, &, w,                          
          db $CF, $A6, $88, $10         ; data?  ,  ,  ,                          
          db $5D, $20, $0F, $CD         ; data? ], SPACE,  ,                      
          db $35, $A3, $A6, $85         ; data? 5,  ,  ,                          
          db $20, $0A, $5C, $26         ; data? SPACE,  , \, &                    
          db $0A, $07, $D2, $62         ; data?  ,  ,  , b                        
          db $A6, $8D, $1D, $80         ; data?  ,  ,  ,                          
          db $CC, $35, $39, $0D         ; data?  , 5, 9,                          
          db $5D, $2B, $06, $7F         ; data? ], +,  , DEL                      
          db $28, $CC, $35, $CB         ; data? (,  , 5,                          
          db $A6, $44, $1C, $C5         ; data?  , D,  ,                          
          db $20, $30, $06, $CE         ; data? SPACE, 0,  ,                      
          db $1C, $06, $8E, $19         ; data?  ,  ,  ,                          
          db $06, $D2, $76, $0A         ; data?  ,  , v,                          
          db $7F, $46, $81, $06         ; data? DEL, F,  ,                        
          db $CE, $0F, $A6, $30         ; data?  ,  ,  , 0                        
          db $06, $8E, $08, $03         ; data?  ,  ,  ,                          
          db $A1, $03, $07, $D2         ; data?  ,  ,  ,                          
          db $1A, $A6, $B0, $B7         ; data?  ,  ,  ,                          
          db $77, $81, $09, $BA         ; data? w,  ,  ,                          
          db $06, $19, $BA, $A6         ; data?  ,  ,  ,                          
          db $F1, $20, $07, $A6         ; data?  , SPACE,  ,                      
          db $66, $05, $B8, $02         ; data? f,  ,  ,                          
          db $A6, $26, $B7, $B3         ; data?  , &,  ,                          
          db $CC, $35, $68, $A6         ; data?  , 5, h,                          
          db $24, $06, $8E, $C2         ; data? $,  ,  ,                          
          db $06, $D2, $42, $0A         ; data?  ,  , B,                          
          db $7F, $06, $0D, $B5         ; data? DEL,  ,  ,                        
          db $E6, $04, $B8, $E3         ; data?  ,  ,  ,                          
          db $04, $BE, $D6, $03         ; data?  ,  ,  ,                          
          db $A1, $06, $A6, $80         ; data?  ,  ,  ,                          
          db $B7, $A0, $20, $77         ; data?  ,  , SPACE, w                    
          db $B6, $A2, $A4, $0F         ; data?  ,  ,  ,                          
          db $0B, $7F, $07, $27         ; data?  , DEL,  , '                      
          db $6E, $CD, $35, $A3         ; data? n,  , 5,                          
          db $20, $35, $00, $A1         ; data? SPACE, 5,  ,                      
          db $02, $27, $0D, $19         ; data?  , ',  ,                          
          db $BA, $A6, $FF, $B7         ; data?  ,  ,  ,                          
          db $CF, $14, $CE, $A6         ; data?  ,  ,  ,                          
          db $80, $CC, $34, $8B         ; data?  ,  , 4,                          
          db $3F, $C8, $A6, $8A         ; data?  ,  ,  ,                          
          db $CD, $23, $F3, $A6         ; data?  ,  #,  ,                         
          db $2C, $CD, $24, $A8         ; data? ,,  , $,                          
          db $81, $CD, $35, $A3         ; data?  ,  , 5,                          
          db $A6, $80, $02, $A1         ; data?  ,  ,  ,                          
          db $13, $B6, $A2, $A1         ; data?  ,  ,  ,                          
          db $0F, $27, $08, $4A         ; data?  , ',  , J                        
          db $CD, $25, $2C, $B1         ; data?  , %, ,,                          
          db $A2, $24, $03, $A6         ; data?  , $,  ,                          
          db $86, $C1, $A6, $84         ; data?  ,  ,  ,                          
          db $1A, $7F, $B7, $A0         ; data?  , DEL,  ,                        
          db $20, $57, $03, $5F         ; data? SPACE, W,  , _                    
          db $03, $CC, $34, $C8         ; data?  ,  , 4,                          
          db $0A, $7F, $5A, $14         ; data?  , DEL, Z,                        
          db $7E, $10, $80, $A6         ; data? ~,  ,  ,                          
          db $02, $B7, $7F, $AE         ; data?  ,  , DEL,                        
          db $06, $CD, $25, $57         ; data?  ,  , %, W                        
          db $A6, $08, $B7, $CE         ; data?  ,  ,  ,                          
          db $A6, $26, $B7, $B3         ; data?  , &,  ,                          
          db $1B, $D2, $A6, $14         ; data?  ,  ,  ,                          
          db $AD, $31, $19, $B3         ; data?  , 1,  ,                          
          db $1B, $B6, $81, $1B         ; data?  ,  ,  ,                          
          db $7F, $13, $CE, $11         ; data? DEL,  ,  ,                        
          db $CE, $17, $D2, $20         ; data?  ,  ,  , SPACE                    
          db $2A, $0A, $7F, $2D         ; data? *,  , DEL, -                      
          db $08, $BA, $2A, $B6         ; data?  ,  , *,                          
          db $A2, $A4, $0F, $27         ; data?  ,  ,  , '                        
          db $93, $A6, $86, $B7         ; data?  ,  ,  ,                          
          db $A0, $19, $BA, $17         ; data?  ,  ,  ,                          
          ...
          db $80, $15, $CE, $B7         ; data?  ,  ,  ,                          
          db $CF, $12, $CE, $10         ; data?  ,  ,  ,                          
          db $CE, $1A, $7F, $B7         ; data?  ,  , DEL,                        
          db $CF, $18, $B3, $1A         ; data?  ,  ,  ,                          
          db $B3, $1F, $D2, $14         ; data?  ,  ,  ,                          
          db $CB, $16, $7E, $1E         ; data?  ,  , ~,                          
          db $5D, $81, $16, $D2         ; data? ],  ,  ,                          
          db $A6, $32, $20, $DF         ; data?  , 2, SPACE,                      
          db $B6, $A2, $A1, $0F         ; data?  ,  ,  ,                          
          db $26, $04, $A6, $01         ; data? &,  ,  ,                          
          db $20, $0B, $CD, $25         ; data? SPACE,  ,  , %                    
          db $25, $B7, $5B, $B6         ; data? %,  , [,                          
          db $A2, $B0, $5B, $A4         ; data?  ,  , [,                          
          db $0F, $B7, $C8, $AB         ; data?  ,  ,  ,                          
          db $2C, $CD, $24, $A8         ; data? ,,  , $,                          
          db $A6, $8A, $CD, $23         ; data?  ,  ,  ,  #                       
          db $EA, $81, $5F, $0B         ; data?  ,  , _,                          
          db $CE, $02, $AE, $0E         ; data?  ,  ,  ,                          
          db $D6, $35, $E8, $B7         ; data?  , 5,  ,                          
          db $56, $D6, $35, $E7         ; data? V,  , 5,                          
          db $27, $0B, $CD, $27         ; data? ',  ,  , '                        
          db $97, $26, $F1, $DE         ; data?  , &,  ,                          
          db $35, $E6, $DD, $34         ; data? 5,  ,  , 4                        
          db $99, $81, $E8, $13         ; data?  ,  ,  ,                          
          db $C8, $3B, $A8, $A6         ; data?  , ;,  ,                          
          db $28, $00, $AB, $D9         ; data? (,  ,  ,                          
          db $AE, $D9, $08, $06         ; data?  ,  ,  ,                          
...
L37D7: 
          ...
          db $17, $27, $2E, $22         ; data?  , ', ., "                        
          db $0C, $B6, $D0, $D1         ; data?  ,  ,  ,                          
          db $38, $38, $22, $0E         ; data? 8, 8, ",                          
          db $27, $11, $4C, $20         ; data? ',  , L, SPACE                    
          db $0E, $B6, $D0, $D1         ; data?  ,  ,  ,                          
          db $38, $3F, $22, $06         ; data? 8,  , ",                          
          db $27, $05, $D6, $38         ; data? ',  ,  , 8                        
          db $38, $B1, $4A, $B7         ; data? 8,  , J,                          
          db $D0, $CD, $25, $25         ; data?  ,  , %, %                        
          db $AB, $A8, $97, $B6         ; data?  ,  ,  ,                          
          db $D0, $A4, $07, $CD         ; data?  ,  ,  ,                          
          db $37, $9B, $CC, $38         ; data? 7,  ,  , 8                        
          db $47, $81, $15, $25         ; data? G,  ,  , %                        
...
L38BC: 
          ...
          brclr 0,PortA,L00DF           ; Branch to 0x00DF if PANEL_STATUS is LOW 
...
; 
          ...
          db $A6, $23, $AE, $03         ; data?  ,  #,  ,                         
          db $CD, $39, $79, $26         ; data?  , 9, y, &                        
          db $E1, $AE, $9E, $CC         ; data?  ,  ,  ,                          
          db $25, $7C                   ; data? %, |,  ,                          
; 
L3943: 
          brclr 2,RAM1_09e,L00ED        ; Branch to 0x00ED if Bit 2 Clear (Mn = 0)
          brset 0,PortA,L01A3           ; Branch to 0x01A3 if PANEL_STATUS is HIGH
          ...
          brset 1,PortA,L0160           ; Branch to 0x0160 if PANEL_DATA is HIGH  
...
L39A4: 
          ...
          brset 1,PortA,L01AE           ; Branch to 0x01AE if PANEL_DATA is HIGH  
          brset 0,PortA,L01AE           ; Branch to 0x01AE if PANEL_STATUS is HIGH
          brset 0,PortA,L01C1           ; Branch to 0x01C1 if PANEL_STATUS is HIGH
          cmp ACH                       ; Compare Accumulator with Memory Byte, (A) - (ACH)
...
; 
          ...
          db $AE, $CF, $CC, $37         ; data?  ,  ,  , 7                        
          db $9B, $0F, $60, $22         ; data?  ,  , `, "                        
          db $0D, $5D, $1F, $AE         ; data?  , ],  ,                          
          db $23, $D6, $3F, $91         ; data?  #,  ,  ,                         
          db $5A, $5A, $B1, $78         ; data? Z, Z,  , x                        
          db $26, $11, $D6, $3F         ; data? &,  ,  ,                          
          db $91, $C7, $02, $D3         ; data?  ,  ,  ,                          
          db $D6, $3F, $92, $C7         ; data?  ,  ,  ,                          
          db $02, $D4, $A6, $FF         ; data?  ,  ,  ,                          
          db $C7, $02, $D5, $5A         ; data?  ,  ,  , Z                        
          db $26, $E3, $81              ; data? &,  ,  ,                          
; 
L3AF9: 
          brclr 2,RAM1_091,L0334        ; Branch to 0x0334 if Bit 2 Clear (Mn = 0)
          sei                           ; Set Interrupt Mask, I ← 1);           
          brclr 7,PortB,L0322           ; Branch to 0x0322 if CONTROL is LOW      
          brclr 1,RAM1_090,L0322        ; Branch to 0x0322 if Bit 1 Clear (Mn = 0)
          brset 3,PortB,L0322           ; Branch to 0x0322 if MUTE_WOOFER is HIGH 
          ...
          cli                           ; Clear Interrupt Mask (I <- 0)           
          brclr 3,PortB,L0376           ; Branch to 0x0376 if MUTE_WOOFER is LOW  
          ...
          sei                           ; Set Interrupt Mask, I ← 1);           
          brclr 7,PortB,L0376           ; Branch to 0x0376 if CONTROL is LOW      
...
; 
          ...
          db $18, $BC, $AE, $04         ; data?  ,  ,  ,                          
          db $03, $01, $0C, $0A         ; data?  ,  ,  ,                          
          db $91, $00, $AD, $42         ; data?  ,  ,  , B                        
          db $C6, $02, $C4, $2A         ; data?  ,  ,  , *                        
          db $02, $13, $01, $AE         ; data?  ,  ,  ,                          
          db $05, $06, $91, $00         ; data?  ,  ,  ,                          
          db $AD, $31, $AE, $09         ; data?  , 1,  ,                          
          db $01, $01, $0C, $08         ; data?  ,  ,  ,                          
          db $91, $00, $AD, $2A         ; data?  ,  ,  , *                        
          db $C6, $02, $C9, $2A         ; data?  ,  ,  , *                        
          db $02, $11, $01, $05         ; data?  ,  ,  ,                          
          db $8E, $11, $03, $5F         ; data?  ,  ,  , _                        
          db $0E, $B6, $9C, $A1         ; data?  ,  ,  ,                          
          db $F4, $22, $08, $AE         ; data?  , ",  ,                          
          db $0A, $09, $6A, $00         ; data?  ,  , j,                          
          db $CD, $3C, $B8, $03         ; data?  , <,  ,                          
          db $8E, $08, $AE, $0B         ; data?  ,  ,  ,                          
          db $0D, $6A, $00, $CD         ; data?  , j,  ,                          
          db $3C, $B8, $81              ; data? <,  ,  ,                          
; 
L3CB8: 
          rora                          ; Rotate Byte at rora Right through Carry Bit, C -> [b7 >>>> b0] -> C
...
; 
          ...
          db $02, $3C, $5B, $C6         ; data?  , <, [,                          
          db $02, $B3, $AE, $80         ; data?  ,  ,  ,                          
          db $CD, $37, $86, $C6         ; data?  , 7,  ,                          
          db $02, $B4, $AE, $81         ; data?  ,  ,  ,                          
          db $CD, $37, $86, $C6         ; data?  , 7,  ,                          
          db $02, $B5, $AE, $82         ; data?  ,  ,  ,                          
          db $CD, $37, $86, $C6         ; data?  , 7,  ,                          
          db $02, $B6, $AE, $83         ; data?  ,  ,  ,                          
          db $CD, $37, $86, $A6         ; data?  , 7,  ,                          
          db $5A, $AE, $72, $CD         ; data? Z,  , r,                          
          db $37, $86, $CD, $3E         ; data? 7,  ,  , >                        
          db $EE, $07, $8E, $2E         ; data?  ,  ,  , .                        
          db $3D, $5B, $26, $2A         ; data? =, [, &, *                        
          db $AE, $12, $CD, $3E         ; data?  ,  ,  , >                        
          db $B2, $AE, $00, $CD         ; data?  ,  ,  ,                          
          ...
          db $03, $D6, $3D, $CF         ; data?  ,  , =,                          
          db $CD, $37, $9B, $CD         ; data?  , 7,  ,                          
          db $07, $89, $5A, $A3         ; data?  ,  , Z,                          
          db $A0, $24, $ED, $AE         ; data?  , $,  ,                          
          db $80, $A6, $03, $CD         ; data?  ,  ,  ,                          
          db $37, $86, $AE, $81         ; data? 7,  ,  ,                          
          db $A6, $22, $CD, $37         ; data?  , ",  , 7                        
          db $86, $A6, $00, $AE         ; data?  ,  ,  ,                          
          db $72, $CD, $37, $86         ; data? r,  , 7,                          
          db $A6, $46, $CD, $23         ; data?  , F,  ,  #                       
          db $EA, $CD, $1E, $B4         ; data?  ,  ,  ,                          
          db $CD, $38, $EF, $CD         ; data?  , 8,  ,                          
          db $07, $89, $20, $FB         ; data?  ,  , SPACE,                      
          db $AE, $63, $A6, $A0         ; data?  , c,  ,                          
          db $CD, $37, $86, $CD         ; data?  , 7,  ,                          
          db $24, $50, $A6, $C4         ; data? $, P,  ,                          
          db $20, $E4, $00, $00         ; data? SPACE,  ,  ,                      
          db $00, $00, $00, $00         ; data?  ,  ,  ,                          
          db $00, $02, $08, $03         ; data?  ,  ,  ,                          
          db $03, $03, $00, $00         ; data?  ,  ,  ,                          
          db $03, $00, $02, $00         ; data?  ,  ,  ,                          
...
; 
          ...
          db $CF, $02, $7B, $1E         ; data?  ,  , {,                          
          db $D6, $3F, $D9, $CD         ; data?  ,  ,  ,                          
          db $07, $89, $CD, $47         ; data?  ,  ,  , G                        
          db $F4, $07, $67, $F7         ; data?  ,  , g,                          
          db $17, $67, $CD, $36         ; data?  , g,  , 6                        
          db $AE, $CD, $47, $AA         ; data?  ,  , G,                          
          db $0E, $D6, $EC, $81         ; data?  ,  ,  ,                          
; 
L3EEE: 
...
; 
          ...
          db $25, $2C, $CD, $25         ; data? %, ,,  , %                        
          db $25, $B7, $52, $27         ; data? %,  , R, '                        
          db $32, $1E, $59, $D6         ; data? 2,  , Y,                          
          db $3F, $8C, $BB, $58         ; data?  ,  ,  , X                        
          ...
          db $02                        ; data?  ,  ,  ,                          
X3F7A: 
          db $A0, $06, $B7, $57         ; data?  ,  ,  , W                        
          db $39, $59, $24, $02         ; data? 9, Y, $,                          
          db $3C, $56, $3A, $52         ; data? <, V, :, R                        
          db $26, $CE, $5C, $5C         ; data? &,  , \, \                        
          db $81, $66, $7C, $68         ; data?  , f, |, h                        
          db $BC, $A6, $FC, $30         ; data?  ,  ,  , 0                        
...
; 
          ...
          db $60, $5B, $08, $60         ; data? `, [,  , `                        
          db $06, $0F, $93, $06         ; data?  ,  ,  ,                          
          db $CC, $40, $6F, $CC         ; data?  , @, o,                          
          db $40, $82, $CD, $42         ; data? @,  ,  , B                        
          db $CC, $27, $58, $CD         ; data?  , ', X,                          
          db $42, $CC, $27, $53         ; data? B,  , ', S                        
          db $B8, $93, $B7, $93         ; data?  ,  ,  ,                          
          db $07, $93, $08, $09         ; data?  ,  ,  ,                          
          ...
          db $D6, $42, $D7, $27         ; data?  , B,  , '                        
          db $22, $C1, $02, $B0         ; data? ",  ,  ,                          
          db $26, $08, $D6, $42         ; data? &,  ,  , B                        
          db $D8, $C1, $02, $B2         ; data?  ,  ,  ,                          
          db $27, $05, $5C, $5C         ; data? ',  , \, \                        
          db $5C, $20, $E9, $A1         ; data? \, SPACE,  ,                      
          db $04, $27, $00, $1D         ; data?  , ',  ,                          
          db $93, $B6, $93, $A4         ; data?  ,  ,  ,                          
          db $1F, $DE, $42, $D9         ; data?  ,  , B,                          
          db $DC, $40, $D6, $AE         ; data?  , @,  ,                          
          db $47, $CD, $42, $96         ; data? G,  , B,                          
          db $81, $1D, $93, $B6         ; data?  ,  ,  ,                          
          ...
          db $A1, $04, $27, $10         ; data?  ,  , ',                          
          db $A1, $05, $27, $23         ; data?  ,  , ',  #                       
          db $A0, $14, $24, $46         ; data?  ,  , $, F                        
          db $81, $A6, $01, $0B         ; data?  ,  ,  ,                          
          db $69, $02, $A6, $02         ; data? i,  ,  ,                          
          db $CD, $42, $8C, $18         ; data?  , B,  ,                          
          db $94, $1C, $93, $0E         ; data?  ,  ,  ,                          
          db $92, $2E, $A6, $90         ; data?  , .,  ,                          
          db $B7, $92, $C6, $02         ; data?  ,  ,  ,                          
          db $B0, $AA, $20, $C7         ; data?  ,  , SPACE,                      
          db $02, $B0, $81, $CD         ; data?  ,  ,  ,                          
          db $42, $8C, $18, $94         ; data? B,  ,  ,                          
          db $C6, $01, $20, $C7         ; data?  ,  , SPACE,                      
          db $02, $B4, $C6, $01         ; data?  ,  ,  ,                          
          db $21, $C7, $02, $B5         ; data? !,  ,  ,                          
          db $C6, $01, $22, $C7         ; data?  ,  , ",                          
          db $02, $B6, $C6, $01         ; data?  ,  ,  ,                          
          ...
          db $1E, $60, $1E, $5D         ; data?  , `,  , ]                        
          db $81, $A6, $13, $B7         ; data?  ,  ,  ,                          
          db $93, $4F, $B7, $50         ; data?  , O,  , P                        
          db $AE, $95, $CD, $42         ; data?  ,  ,  , B                        
          db $96, $3F, $57, $CC         ; data?  ,  , W,                          
          db $42, $15, $AE, $CE         ; data? B,  ,  ,                          
          db $4F, $CD, $37, $9B         ; data? O,  , 7,                          
          db $5A, $A3, $C0, $24         ; data? Z,  ,  , $                        
          db $F7, $20, $E2, $A1         ; data?  , SPACE,  ,                      
          db $06, $25, $09, $A1         ; data?  , %,  ,                          
          db $08, $25, $07, $26         ; data?  , %,  , &                        
          db $03, $CC, $42, $1B         ; data?  ,  , B,                          
          db $A6, $05, $4C, $CD         ; data?  ,  , L,                          
          db $42, $8C, $1E, $5D         ; data? B,  ,  , ]                        
          db $CD, $3D, $01, $81         ; data?  , =,  ,                          
          db $CE, $02, $B3, $27         ; data?  ,  ,  , '                        
          db $13, $A3, $07, $22         ; data?  ,  ,  , "                        
          db $10, $BF, $5B, $DE         ; data?  ,  , [,                          
          db $42, $FC, $CD, $42         ; data? B,  ,  , B                        
          db $96, $18, $94, $BE         ; data?  ,  ,  ,                          
          db $5B, $CD, $3D, $1A         ; data? [,  , =,                          
          db $81, $A3, $19, $26         ; data?  ,  ,  , &                        
          db $FB, $05, $60, $F8         ; data?  ,  , `,                          
          ...
          db $02, $B3, $C6, $02         ; data?  ,  ,  ,                          
          db $B4, $CD, $3F, $2D         ; data?  ,  ,  , -                        
          db $B6, $57, $C1, $01         ; data?  , W,  ,                          
          db $01, $26, $0F, $B6         ; data?  , &,  ,                          
          db $58, $C1, $01, $02         ; data? X,  ,  ,                          
          db $26, $08, $CD, $36         ; data? &,  ,  , 6                        
          db $5D, $15, $5D, $14         ; data? ],  , ],                          
          db $60, $81, $3C, $8B         ; data? `,  , <,                          
          db $CD, $36, $55, $A6         ; data?  , 6, U,                          
          db $FF, $B7, $8C, $CC         ; data?  ,  ,  ,                          
          db $3F, $C4, $20, $41         ; data?  ,  , SPACE, A                    
          db $03, $60, $3D, $C6         ; data?  , `, =,                          
          db $02, $B3, $B7, $50         ; data?  ,  ,  , P                        
          db $C6, $02, $B5, $B7         ; data?  ,  ,  ,                          
          db $51, $A6, $12, $CD         ; data? Q,  ,  ,                          
          db $42, $8C, $A6, $03         ; data? B,  ,  ,                          
          db $B7, $52, $BE, $51         ; data?  , R,  , Q                        
          db $9F, $A4, $FC, $27         ; data?  ,  ,  , '                        
          db $0B, $A0, $30, $27         ; data?  ,  , 0, '                        
          db $07, $A0, $30, $27         ; data?  ,  , 0, '                        
          db $03, $CD, $37, $C7         ; data?  ,  , 7,                          
          db $3C, $51, $BE, $52         ; data? <, Q,  , R                        
          db $D7, $02, $B0, $3C         ; data?  ,  ,  , <                        
          db $52, $C6, $02, $B0         ; data? R,  ,  ,                          
          db $4C, $C7, $02, $B0         ; data? L,  ,  ,                          
          db $A1, $0F, $27, $04         ; data?  ,  , ',                          
          db $3A, $50, $26, $D6         ; data? :, P, &,                          
          db $81, $C6, $02, $B3         ; data?  ,  ,  ,                          
          db $A1, $AB, $26, $0A         ; data?  ,  , &,                          
          db $C6, $02, $B4, $A1         ; data?  ,  ,  ,                          
          db $CD, $26, $03, $CC         ; data?  , &,  ,                          
          ...
          db $E3, $C6, $02, $B4         ; data?  ,  ,  ,                          
          db $C1, $01, $02, $26         ; data?  ,  ,  , &                        
          db $DB, $CC, $3E, $61         ; data?  ,  , >, a                        
          db $3C, $50, $3C, $93         ; data? <, P, <,                          
          db $BE, $50, $A3, $0E         ; data?  , P,  ,                          
          db $23, $05, $3F, $93         ; data?  #,  ,  ,                         
          db $1E, $93, $81, $D6         ; data?  ,  ,  ,                          
          db $01, $C0, $27, $EC         ; data?  ,  , ',                          
          db $A3, $02, $27, $14         ; data?  ,  , ',                          
          ...
          db $A3, $05, $27, $0C         ; data?  ,  , ',                          
          db $A3, $06, $26, $0D         ; data?  ,  , &,                          
          db $5A, $D1, $01, $C0         ; data? Z,  ,  ,                          
          db $25, $D6, $20, $05         ; data? %,  , SPACE,                      
          db $D1, $01, $C1, $23         ; data?  ,  ,  ,  #                       
          db $CF, $A1, $33, $26         ; data?  ,  , 3, &                        
          db $01, $4F, $B7, $51         ; data?  , O,  , Q                        
          db $BE, $57, $5C, $5C         ; data?  , W, \, \                        
          db $5C, $A3, $0C, $23         ; data? \,  ,  ,  #                       
          db $03, $1C, $93, $81         ; data?  ,  ,  ,                          
          db $BF, $57, $9F, $AB         ; data?  , W,  ,                          
          db $03, $C7, $02, $B0         ; data?  ,  ,  ,                          
          db $B6, $50, $48, $BB         ; data?  , P, H,                          
          db $50, $B7, $58, $BE         ; data? P,  , X,                          
          db $58, $D6, $43, $AF         ; data? X,  , C,                          
          db $BE, $57, $D7, $02         ; data?  , W,  ,                          
          db $B0, $BE, $58, $D6         ; data?  ,  , X,                          
          db $43, $B0, $BE, $57         ; data? C,  ,  , W                        
          db $D7, $02, $B1, $BE         ; data?  ,  ,  ,                          
          db $58, $D6, $43, $B1         ; data? X,  , C,                          
          db $3D, $51, $26, $02         ; data? =, Q, &,                          
          db $A4, $7F, $BE, $57         ; data?  , DEL,  , W                      
          db $D7, $02, $B2, $18         ; data?  ,  ,  ,                          
          db $94, $20, $85, $B7         ; data?  , SPACE,  ,                      
          db $93, $B6, $93, $A4         ; data?  ,  ,  ,                          
          db $1F, $97, $DE, $42         ; data?  ,  ,  , B                        
          db $F3, $1E, $93, $3F         ; data?  ,  ,  ,                          
          db $56, $BF, $57, $1B         ; data? V,  , W,                          
          db $5D, $A3, $49, $26         ; data? ],  , I, &                        
          db $02, $1A, $5D, $D6         ; data?  ,  , ],                          
          db $43, $15, $C7, $02         ; data? C,  ,  ,                          
          db $B0, $A4, $0F, $A0         ; data?  ,  ,  ,                          
          db $03, $B7, $58, $A6         ; data?  ,  , X,                          
          db $FF, $C7, $02, $B1         ; data?  ,  ,  ,                          
          db $BE, $57, $D6, $43         ; data?  , W,  , C                        
          db $16, $BE, $56, $D7         ; data?  ,  , V,                          
          db $02, $B2, $3C, $56         ; data?  ,  , <, V                        
          db $3C, $57, $3A, $58         ; data? <, W, :, X                        
          db $2A, $EE, $1E, $95         ; data? *,  ,  ,                          
          db $18, $92, $81, $4F         ; data?  ,  ,  , O                        
          db $03, $03, $02, $A6         ; data?  ,  ,  ,                          
          db $20, $B8, $93, $A4         ; data? SPACE,  ,  ,                      
          db $20, $81, $03, $00         ; data? SPACE,  ,  ,                      
          db $00, $03, $07, $40         ; data?  ,  ,  , @                        
          db $03, $05, $51, $04         ; data?  ,  , Q,                          
          db $04, $5E, $04, $29         ; data?  , ^,  , )                        
          db $77, $07, $10, $9A         ; data? w,  ,  ,                          
          db $08, $2B, $A0, $05         ; data?  , +,  ,                          
          db $1B, $D1, $06, $03         ; data?  ,  ,  ,                          
          db $D3, $00, $15, $01         ; data?  ,  ,  ,                          
          db $0F, $1D, $2B, $38         ; data?  ,  , +, 8                        
          db $3B, $3F, $43, $47         ; data? ;,  , C, G                        
          ...
          db $AF, $B2, $B5, $B8         ; data?  ,  ,  ,                          
          db $BB, $BE, $C1, $C4         ; data?  ,  ,  ,                          
          db $81, $0F, $F6, $34         ; data?  ,  ,  , 4                        
          db $42, $30, $30, $33         ; data? B, 0, 0, 3                        
          db $35, $31, $38, $36         ; data? 5, 1, 8, 6                        
          db $20, $20, $20, $0F         ; data? SPACE, SPACE, SPACE,              
          db $F6, $34, $42, $30         ; data?  , 4, B, 0                        
          db $30, $33, $35, $31         ; data? 0, 3, 5, 1                        
          db $35, $32, $20, $20         ; data? 5, 2, SPACE, SPACE                
          db $20, $0F, $F6, $20         ; data? SPACE,  ,  , SPACE                
          db $52, $61, $64, $69         ; data? R, a, d, i                        
          db $6F, $20, $20, $20         ; data? o, SPACE, SPACE, SPACE            
          db $20, $20, $20, $0E         ; data? SPACE, SPACE, SPACE,              
          db $F6, $20, $20, $20         ; data?  , SPACE, SPACE, SPACE            
          db $20, $20, $20, $20         ; data? SPACE, SPACE, SPACE, SPACE        
          db $30, $30, $30, $31         ; data? 0, 0, 0, 1                        
          db $08, $F6, $00, $05         ; data?  ,  ,  ,                          
          db $F5, $03, $53, $05         ; data?  ,  , S,                          
          db $F5, $03, $56, $05         ; data?  ,  , V,                          
          db $F5, $04, $AB, $44         ; data?  ,  ,  , D                        
          db $0A, $0F, $E7, $10         ; data?  ,  ,  ,                          
          db $08, $00, $06, $4E         ; data?  ,  ,  , N                        
          db $C0, $17, $64, $80         ; data?  ,  , d,                          
          db $25, $00, $87, $0F         ; data? %,  ,  ,                          
          db $E7, $25, $00, $F0         ; data?  , %,  ,                          
          db $25, $00, $C2, $11         ; data? %,  ,  ,                          
          db $20, $20, $11, $20         ; data? SPACE, SPACE,  , SPACE            
          db $20, $0C, $E7, $25         ; data? SPACE,  ,  , %                    
          db $01, $11, $25, $00         ; data?  ,  , %,                          
          db $F4, $25, $00, $C2         ; data?  , %,  ,                          
          db $0F, $E7, $10, $01         ; data?  ,  ,  ,                          
          db $00, $11, $20, $20         ; data?  ,  , SPACE, SPACE                
          db $25, $00, $F5, $25         ; data? %,  ,  , %                        
          db $00, $88, $09, $E7         ; data?  ,  ,  ,                          
          db $25, $00, $F6, $25         ; data? %,  ,  , %                        
          db $00, $C2, $09, $E7         ; data?  ,  ,  ,                          
          db $25, $00, $F7, $25         ; data? %,  ,  , %                        
          db $00, $C2, $06, $E7         ; data?  ,  ,  ,                          
          db $11, $20, $20, $03         ; data?  , SPACE, SPACE,                  
          db $FD, $06, $FC, $FF         ; data?  ,  ,  ,                          
          db $FF, $88, $03, $51         ; data?  ,  ,  , Q                        
          db $A4, $02, $9C, $87         ; data?  ,  ,  ,                          
          db $03, $58, $A4, $03         ; data?  , X,  ,                          
          db $58, $9D, $03, $52         ; data? X,  ,  , R                        
          db $9D, $03, $54, $AC         ; data?  ,  , T,                          
          db $03, $54, $A4, $03         ; data?  , T,  ,                          
          db $55, $AC, $03, $55         ; data? U,  ,  , U                        
          db $A4, $03, $58, $9D         ; data?  ,  , X,                          
          db $03, $56, $B1, $03         ; data?  , V,  ,                          
          db $57, $B1, $03, $57         ; data? W,  ,  , W                        
          db $9D, $FF, $FF, $00         ; data?  ,  ,  ,                          
          db $04, $14, $23, $00         ; data?  ,  ,  #,                         
          db $81, $A6, $07, $CD         ; data?  ,  ,  ,                          
          db $24, $9F, $A6, $14         ; data? $,  ,  ,                          
...
; 
          db $0D, $CE, $CB, $BE         ; data?  ,  ,  ,                          
          db $D0, $A6, $05, $0C         ; data?  ,  ,  ,                          
          db $6A, $02, $A6, $07         ; data? j,  ,  ,                          
          db $A3, $01, $27, $3F         ; data?  ,  , ',                          
          db $A6, $CA, $A3, $08         ; data?  ,  ,  ,                          
          db $27, $39, $9F, $AE         ; data? ', 9,  ,                          
          db $07, $A1, $09, $27         ; data?  ,  ,  , '                        
          db $12, $A1, $0A, $27         ; data?  ,  ,  , '                        
          db $18, $A1, $0B, $26         ; data?  ,  ,  , &                        
          db $1F, $E6, $A3, $D7         ; data?  ,  ,  ,                          
          db $02, $57, $5A, $2A         ; data?  , W, Z, *                        
          db $F8, $20, $1E, $E6         ; data?  , SPACE,  ,                      
          db $DA, $D7, $02, $57         ; data?  ,  ,  , W                        
          db $5A, $2A, $F8, $20         ; data? Z, *,  , SPACE                    
          db $14, $D6, $44, $82         ; data?  ,  , D,                          
          db $D7, $02, $57, $5A         ; data?  ,  , W, Z                        
          db $2A, $F7, $20, $09         ; data? *,  , SPACE,                      
          db $D6, $01, $90, $D7         ; data?  ,  ,  ,                          
          db $02, $57, $5A, $2A         ; data?  , W, Z, *                        
          db $F7, $A6, $C4, $CC         ; data?  ,  ,  ,                          
          db $23, $EA                   ; data?  #,  ,  ,                         
X4479: 
          db $00, $01, $03, $04         ; data?  ,  ,  ,                          
          db $05, $06, $08, $09         ; data?  ,  ,  ,                          
          db $0A, $37, $31, $32         ; data?  , 7, 1, 2                        
          db $38, $2E, $31, $20         ; data? 8, ., 1, SPACE                    
          db $4D                        ; data? M,  ,  ,                          
; 
L448A: 
          clrx                          ; Clear byte at clrx <- 0x00              
...
L44BC: 
          ...
          db $A4, $07, $B7, $C8         ; data?  ,  ,  ,                          
          db $4A, $CD, $25, $72         ; data? J,  , %, r                        
          db $C4, $02, $66, $26         ; data?  ,  , f, &                        
          db $0C, $A6, $88, $CD         ; data?  ,  ,  ,                          
          db $23, $F3, $B6, $C8         ; data?  #,  ,  ,                         
          db $AA, $20, $CD, $24         ; data?  , SPACE,  , $                    
          db $A8, $B6, $C8, $AA         ; data?  ,  ,  ,                          
          db $C0, $97, $20, $B4         ; data?  ,  , SPACE,                      
          db $A6, $05, $CD, $24         ; data?  ,  ,  , $                        
          db $73, $C6, $02, $60         ; data? s,  ,  , `                        
          db $A4, $07, $B7, $C8         ; data?  ,  ,  ,                          
...
; 
          ...
          db $18, $BC, $A6, $40         ; data?  ,  ,  , @                        
          db $B8, $D3, $B7, $D3         ; data?  ,  ,  ,                          
          db $AE, $A5, $CD, $37         ; data?  ,  ,  , 7                        
          db $9B, $20, $39, $07         ; data?  , SPACE, 9,                      
...
; 
          db $0B, $D3, $03, $02         ; data?  ,  ,  ,                          
          db $6A, $36, $01, $7C         ; data? j, 6,  , |                        
          db $09, $A6, $03, $04         ; data?  ,  ,  ,                          
          db $7C, $0B, $A6, $04         ; data? |,  ,  ,                          
          db $20, $07, $A6, $03         ; data? SPACE,  ,  ,                      
          db $05, $7C, $02, $A6         ; data?  , |,  ,                          
          db $04, $13, $6A, $CC         ; data?  ,  , j,                          
          db $23, $EA                   ; data?  #,  ,  ,                         
; 
L471A: 
          bclr 4,STACK_0cb              ; Clear bit 4 at STACK_0cb                
...
L477E: 
          ...
          brclr 3,PortA,L07A9           ; Branch to 0x07A9 if SLAVE_STATUS is LOW 
          jsr L483E                     ; Jump to Subroutine at 0x483E            
          bclr 5,PortB                  ; Set RESET_SLAVE LOW                     
          jsr L253F                     ; Jump to Subroutine at 0x253F            
          bset 5,PortB                  ; Set RESET_SLAVE HIGH                    
...
; 
L47F4: 
          brset 5,PortA,L003D           ; Branch to 0x003D if SLAVE_DATA is HIGH  
...
L48B3: 
          ...
          brclr 4,PortA,L010D           ; Branch to 0x010D if SLAVE_CLOCK is LOW  
          decx                          ; Decrement Byte at decx Byte = Byte - 1  
          ...
          brclr 5,PortA,L0117           ; Branch to 0x0117 if SLAVE_DATA is LOW   
...
L4917: 
          ...
          brclr 5,PortA,L0147           ; Branch to 0x0147 if SLAVE_DATA is LOW   
...
L4969: 
          ...
          brset 4,PortA,L0182           ; Branch to 0x0182 if SLAVE_CLOCK is HIGH 
          dec RAM1_056                  ; Decrement Byte at RAM1_056 Byte = Byte - 1
...
; 
          db $00, $5E, $3E, $01         ; data?  , ^, >,                          
          db $50, $05, $CD, $49         ; data? P,  ,  , I                        
          db $82, $20, $0F, $3F         ; data?  , SPACE,  ,                      
          db $56, $18, $56              ; data? V,  , V,                          
; 
L4992: 
          brclr 4,PortA,L019B           ; Branch to 0x019B if SLAVE_CLOCK is LOW  
          dec RAM1_056                  ; Decrement Byte at RAM1_056 Byte = Byte - 1
...
L49C9: 
          ...
          bsr L0163                     ; Branch to Subroutine at 0x0163          
          brset 5,PortA,L01D8           ; Branch to 0x01D8 if SLAVE_DATA is HIGH  
          rola                          ; Rotate Byte at rola Left through Carry Bit, C <- [b7 <<<< b0] <- C
...
; 
          ...
          db $AF, $CD, $49, $63         ; data?  ,  , I, c                        
          db $20, $0B, $1B, $04         ; data? SPACE,  ,  ,                      
          db $CD, $49, $63, $0B         ; data?  , I, c,                          
          db $00, $03, $10, $5E         ; data?  ,  ,  , ^                        
          db $9A, $B6, $52, $BB         ; data?  ,  , R,                          
          db $51, $28, $02, $A0         ; data? Q, (,  ,                          
          db $10, $B7, $51, $CD         ; data?  ,  , Q,                          
          db $49, $83, $20, $9A         ; data? I,  , SPACE,                      
; 
L4A15: 
          rts                           ; Return from Subroutine                  
; 
          db $04, $8B, $3A, $0D         ; data?  ,  , :,                          
          db $5D, $37, $CC, $4A         ; data? ], 7,  , J                        
          db $C2, $19, $BA, $1E         ; data?  ,  ,  ,                          
          db $5D, $A6, $70, $B7         ; data? ],  , p,                          
          db $77, $81, $0E, $CE         ; data? w,  ,  ,                          
          db $29, $07, $8B, $05         ; data? ),  ,  ,                          
          db $0F, $8B, $1B, $17         ; data?  ,  ,  ,                          
          db $8B, $18, $B3, $3F         ; data?  ,  ,  ,                          
          db $CE, $1E, $CE, $3C         ; data?  ,  ,  , <                        
          db $8B, $15, $8B, $A6         ; data?  ,  ,  ,                          
          db $10, $C7, $02, $9E         ; data?  ,  ,  ,                          
          db $4F, $C7, $02, $9F         ; data? O,  ,  ,                          
          db $A6, $0C, $0F, $8B         ; data?  ,  ,  ,                          
          db $4F, $C1, $A6, $0B         ; data? O,  ,  ,                          
          db $12, $CB, $CD, $23         ; data?  ,  ,  ,  #                       
          db $F3, $81, $1F, $CE         ; data?  ,  ,  ,                          
          db $CE, $02, $9E, $C3         ; data?  ,  ,  ,                          
          db $01, $01, $26, $0F         ; data?  ,  , &,                          
          ...
          db $01, $02, $26, $07         ; data?  ,  , &,                          
          db $BF, $8C, $B7, $8D         ; data?  ,  ,  ,                          
          db $CC, $36, $5D, $0E         ; data?  , 6, ],                          
          db $8B, $C3, $CC, $36         ; data?  ,  ,  , 6                        
          db $55, $5F, $C1, $AE         ; data? U, _,  ,                          
          db $01, $A6, $70, $DB         ; data?  ,  , p,                          
          db $02, $9E, $25, $11         ; data?  ,  , %,                          
          db $AB, $A0, $20, $0D         ; data?  ,  , SPACE,                      
          db $5F, $C1, $AE, $01         ; data? _,  ,  ,                          
          db $A6, $F7, $DB, $02         ; data?  ,  ,  ,                          
          db $9E, $29, $02, $AB         ; data?  , ),  ,                          
          db $0A, $D7, $02, $9E         ; data?  ,  ,  ,                          
          db $A6, $50, $B7, $77         ; data?  , P,  , w                        
          db $14, $CB, $13, $CB         ; data?  ,  ,  ,                          
          db $1E, $5D, $81              ; data?  , ],  ,                          
; 
L4A9D: 
...
; 
          ...
          db $5F, $CD, $24, $03         ; data? _,  , $,                          
          db $CC, $24, $13, $5F         ; data?  , $,  , _                        
          db $0E, $CE, $02, $AE         ; data?  ,  ,  ,                          
          db $10, $D6, $4A, $DF         ; data?  ,  , J,                          
          db $B7, $56, $D6, $4A         ; data?  , V,  , J                        
          db $DE, $27, $0B, $CD         ; data?  , ',  ,                          
          db $27, $97, $26, $F1         ; data? ',  , &,                          
          db $DE, $4A, $DD, $DD         ; data?  , J,  ,                          
          db $4A, $1F, $81, $E1         ; data? J,  ,  ,                          
...
; 
          ...
          db $24, $12, $B6, $9C         ; data? $,  ,  ,                          
          db $D1, $4C, $62, $22         ; data?  , L, b, "                        
          db $0B, $26, $07, $B6         ; data?  , &,  ,                          
          db $9D, $D1, $4C, $63         ; data?  ,  , L, c                        
          ...
          db $4B, $17, $3A, $50         ; data? K,  , :, P                        
          db $26, $F1, $CD, $4B         ; data? &,  ,  , K                        
          db $50, $97, $B1, $51         ; data? P,  ,  , Q                        
          db $81                        ; data?  ,  ,  ,                          
X4C08: 
          db $4A                        ; data? J,  ,  ,                          
X4C09: 
